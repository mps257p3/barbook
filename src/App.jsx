...
const CARD_TYPO = {
  ...
  tag:         { fontSize:10, letterSpacing:2, textTransform:"uppercase", color:"rgba(231,224,205,0.62)", fontWeight:600, fontFamily:"Archivo,sans-serif", lineHeight:1, textShadow:"0 1px 4px rgba(0,0,0,0.9)" },
  ...
  sigLabel:    { fontSize:7.5, letterSpacing:1.5, textTransform:"uppercase", color:"rgba(231,224,205,0.64)", fontWeight:600, fontFamily:"Archivo,sans-serif", lineHeight:1.6 },
  // ── Assinatura: valor (Elegante / Aveludado / Aperitivo) — fontSize por length ─
  sigValue:    { letterSpacing:0.5, textTransform:"uppercase", color:"rgba(231,224,205,0.85)", fontWeight:600, fontFamily:"Archivo,sans-serif", lineHeight:1.5, textAlign:"center" },
  ...
  bodyText:    { fontSize:14, color:"rgba(231,224,205,0.75)", lineHeight:1.6, fontFamily:"Archivo,sans-serif" },
  // ── Notas (itálico, mais suave) ───────────────────────────────────────────────
  noteText:    { fontSize:13, color:"rgba(231,224,205,0.67)", lineHeight:1.7, fontFamily:"Archivo,sans-serif", fontStyle:"italic" },
...
const ROLE = {
  ...
  text2: "rgba(240,235,225,0.66)",   // corpo
  text3: "rgba(240,235,225,0.52)",   // legendas / apoio
...
function chip(variant="neutral", accent="#C8A96E"){
  ...
  return {...base,background:"rgba(240,235,225,0.05)",border:"1px solid rgba(240,235,225,0.12)",color:"rgba(240,235,225,0.6)"};
}
...
const BASE_RECIPES = [
  ...
  {name:"Sazerac",categories:["Brandy","Stirred"],ingredients:["60 ml Conhaque","5 ml xarope simples","3 dashes Absinto","2 dashes Peychaud's bitters","casca de limão"],steps:["Passe o absinto no copo e descarte o excesso.","Adicione conhaque, xarope e bitters com gelo. Mexa.","Coe no copo preparado. Decore com limão.","Receita de Xarope Simples disponível em Preparos Caseiros."],notes:"",rating:0,servings:"",custom:false},
  {name:"SAZERAC por Kennedy Nascimento",categories:["Brandy","Whisky","Stirred"],ingredients:["30 ml cognac VSOP","30 ml bourbon ou centeio","1 torrão açúcar","Spray de Absinto","4 dashes Peychaud's","2 dashes angostura","Zest limão siciliano"],steps:["Suje o copo com absinto e reserve com gelo.","Macere açúcar com bitters no mixing glass. Adicione cognac e mexa.","Retire o gelo, verta o drink. Decore com zest."],notes:"",rating:0,servings:"",custom:false},
  ...
  // ── COGNAC / BRANDY ──
  {name:"Brandy Alexander",categories:["Brandy","Licor","Shaken"],ingredients:["30 ml conhaque","30 ml creme de cacau escuro","30 ml creme de leite fresco","noz-moscada"],steps:["Bata tudo com gelo.","Coe em taça coupe.","Finalize com noz-moscada ralada."],notes:"",rating:0,servings:"",custom:false},
  {name:"Between the Sheets",categories:["Brandy","Rum Branco","Triple Sec","Sour","Shaken"],ingredients:["30 ml conhaque","30 ml rum branco","30 ml Cointreau","15 ml suco de limão"],steps:["Bata tudo com gelo.","Coe em taça coupe."],notes:"",rating:0,servings:"",custom:false},
  {name:"Stinger",categories:["Brandy","Licor","Stirred"],ingredients:["60 ml conhaque","20 ml creme de menta branco"],steps:["Mexa com gelo.","Coe em coupe ou sirva em rocks com gelo britado."],notes:"",rating:0,servings:"",custom:false},
  {name:"French Connection",categories:["Brandy","Stirred"],ingredients:["45 ml conhaque","25 ml Amaretto"],steps:["Coloque gelo em rocks.","Adicione e mexa suavemente."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Spiced Nightcap",categories:["Brandy","Drambuie","Stirred"],ingredients:["40 ml Drambuie","20 ml conhaque","10 ml creme de cacau","1 dash bitters"],steps:["Mexa tudo com gelo.","Sirva em taça pequena ou coupe."],notes:"Meio bombom adulto derretido, meio digestivo elegante. Para terminar a noite.",rating:0,servings:"1",custom:false},
  ...
  {name:"Champagne Cocktail",categories:["Brandy","Espumante","Sparkling","Built"],ingredients:["90 ml champagne ou espumante brut gelado","20 ml conhaque","1 cubo de açúcar","2 dashes Angostura Bitters"],steps:["Embeba o cubo de açúcar com Angostura e coloque no fundo da taça.","Adicione o conhaque.","Complete devagar com o champagne gelado."],notes:"Um dos primeiros coquetéis documentados (1862). O cubo dissolve enquanto você bebe.",rating:0,servings:"1",custom:false},
  ...
  {name:"Brandy Crusta",categories:["Brandy","Luxardo Maraschino","Sour","Stirred"],ingredients:["52 ml conhaque","7 ml Luxardo Maraschino","7 ml Curaçao de laranja","15 ml suco de limão","5 ml xarope simples","2 dashes Angostura","açúcar na borda"],steps:["Prepare a borda da taça com açúcar.","Mexa todos os ingredientes com gelo.","Coe na taça preparada.","Receita de Xarope Simples disponível em Preparos Caseiros."],notes:"De Nova Orleans, c. 1850 — ancestral direto do Sidecar e do Cosmopolitan.",rating:0,servings:"1",custom:false},
...
function getMood(recipe) {
  ...
  if (has("Whisky","Brandy") && has("Stirred","Built") && !has("Highball"))       return "smoked_amber";
  ...
  if (has("Whisky","Brandy","Mezcal"))                                            return "smoked_amber";
...
// Capa de coleção: mostra a imagem; na ausência, falha OU travamento do
// carregamento, exibe o nome da coleção no lugar. `timeout` define em quantos
// ms um carregamento "preso" passa a ser tratado como falha. `fallback` permite
// um conteúdo customizado no lugar do nome simples.
function PackCover({src,name,imgStyle,fallbackHeight=80,dim=false,timeout=6000,fallback=null}){
  ...
  useEffect(()=>{
    ...
    if(img&&img.complete&&img.naturalWidth>0)return; // já em cache
    timerRef.current=setTimeout(()=>{
      const el=imgRef.current;
      if(!el||!(el.complete&&el.naturalWidth>0))setErr(true); // travou → mostra nome
    },timeout);
    return ()=>clearTimeout(timerRef.current);
  },[src,timeout]);
  if(src&&!err) return <img ref={imgRef} src={src} alt={name} style={imgStyle}
    onLoad={()=>clearTimeout(timerRef.current)}
    onError={()=>{clearTimeout(timerRef.current);setErr(true);}}/>;
  ...
  return(
    <div style={{height:fallbackHeight,background:"linear-gradient(135deg,rgba(160,120,90,0.22) 0%,rgba(0,0,0,0.5) 100%)",display:"flex",alignItems:"center",padding:"0 18px",opacity:dim?0.85:1}}>
      <div style={{fontFamily:"'Gloock',serif",fontSize:fallbackHeight>=80?20:16,lineHeight:1.15,color:"rgba(231,224,205,0.93)"}}>{name}</div>
    </div>
  );
}
...
const labelSt = { display:"block", fontSize:9, letterSpacing:2.5, textTransform:"uppercase", color:"rgba(240,235,225,0.66)", fontWeight:700, marginBottom:7 };
const addBtnSt = { marginTop:4, padding:"5px 12px", borderRadius:3, background:"none", border:"1px solid rgba(240,235,225,0.1)", color:"rgba(240,235,225,0.66)", cursor:"pointer", fontSize:11, letterSpacing:.5, fontFamily:"Archivo,sans-serif" };

function RecipeForm({ initial, initialProfile=null, onSave, onClose, customSpirits=[], baseSpirits=ALL_SPIRIT_OPTIONS, sharedFiles=null, existingNames=null }) {
  ...
  const handleSave = () => {
    ...
    const editingName=(initial?.name||"").trim().toLowerCase();
    if(existingNames && nm!==editingName && existingNames.has(nm)){
      setNameErr("Já existe uma receita com esse nome. Use outro.");
      return;
    }
      ...
      <div onClick={e=>e.stopPropagation()} style={{background:"#0A0A0A",border:"1px solid rgba(240,235,225,0.15)",borderRadius:6,width:"100%",maxWidth:620,maxHeight:"92vh",overflowY:"auto"}}>
        <div style={{padding:"24px 28px 30px"}}>
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:initial?22:16}}>
            ...
            <button onClick={onClose} style={{background:"none",border:"1px solid rgba(240,235,225,0.1)",borderRadius:"50%",width:30,height:30,color:"rgba(240,235,225,0.56)",fontSize:16,cursor:"pointer"}}>×</button>
          </div>
          {!initial&&!previewImgs.length&&!scanning&&(
            <button onClick={()=>photoRef.current?.click()} style={{display:"flex",alignItems:"center",gap:13,width:"100%",marginBottom:20,padding:"13px 16px",borderRadius:4,background:"rgba(200,169,110,0.05)",border:"1px dashed rgba(200,169,110,0.22)",cursor:"pointer",textAlign:"left",transition:"border-color .15s",boxSizing:"border-box"}} onMouseEnter={e=>e.currentTarget.style.borderColor="rgba(200,169,110,0.48)"} onMouseLeave={e=>e.currentTarget.style.borderColor="rgba(200,169,110,0.22)"}>
              ...
              <div>
                ...
                <div style={{fontSize:11,color:"rgba(240,235,225,0.59)",fontFamily:"Archivo,sans-serif",lineHeight:1.45}}>Selecione um ou mais prints — o app transcreve todos automaticamente</div>
              </div>
            </button>
          )}
          ...
          {previewImgs.length>0&&(
            <div style={{marginBottom:16,position:"relative"}}>
              ...
              {!scanning&&<button onClick={()=>setPreviewImgs([])} style={{position:"absolute",top:6,right:6,background:"rgba(0,0,0,0.65)",border:"none",borderRadius:"50%",width:24,height:24,color:"rgba(240,235,225,0.75)",fontSize:13,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}}>×</button>}
            </div>
          )}
          ...
          <input {...inp()} value={form.name} onChange={e=>{setField("name",e.target.value);if(nameErr)setNameErr("");}} placeholder="ex: Gin Sour de Lavanda" style={{...inp().style,marginBottom:nameErr?6:18,fontSize:15,...(nameErr?{borderColor:"rgba(239,68,68,0.5)"}:{})}}/>
          {nameErr&&<div style={{marginBottom:18,fontSize:12,color:"#F87171"}}>⚠ {nameErr}</div>}
          ...
          {form.ingredients.map((ing,i)=>(
            <div key={i} style={{display:"flex",gap:6,marginBottom:6}}>
              ...
              {form.ingredients.length>1&&<button onClick={()=>removeListItem("ingredients",i)} style={{background:"none",border:"1px solid rgba(240,235,225,0.1)",borderRadius:3,color:"rgba(240,235,225,0.66)",width:32,flexShrink:0,cursor:"pointer",fontSize:14}}>×</button>}
            </div>
          ))}
          ...
          <div style={{marginBottom:6}}>
            <div style={{fontSize:9,letterSpacing:2,textTransform:"uppercase",color:"rgba(240,235,225,0.6)",marginBottom:6}}>Família / Técnica</div>
            ...
            <div style={{fontSize:9,letterSpacing:2,textTransform:"uppercase",color:"rgba(240,235,225,0.6)",marginBottom:6}}>Spirits / Ingredientes principais</div>
          ...
          <div style={{marginTop:18,paddingTop:16,borderTop:"1px solid rgba(240,235,225,0.11)"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8}}>
              {[["perfil","Perfil","ex: Elegante"],["sensacao","Sensação","ex: Aveludado"],["ocasiao","Ocasião","ex: Início de noite"]].map(([key,lbl,ph])=>(
                <div key={key}>
                  <div style={{fontSize:9,letterSpacing:2,textTransform:"uppercase",color:"rgba(240,235,225,0.59)",marginBottom:5,fontWeight:700}}>{lbl}</div>
          ...
          {form.steps.map((s,i)=>(
            <div key={i} style={{display:"flex",gap:6,marginBottom:6,alignItems:"flex-start"}}>
              ...
              {form.steps.length>1&&<button onClick={()=>removeListItem("steps",i)} style={{background:"none",border:"1px solid rgba(240,235,225,0.1)",borderRadius:3,color:"rgba(240,235,225,0.66)",width:32,height:32,flexShrink:0,cursor:"pointer",fontSize:14,marginTop:2}}>×</button>}
            </div>
          ))}
          ...
          {subs().map((sp,i)=>(
            <div key={i} style={{border:`1px solid ${theme.border}55`,borderRadius:6,padding:"10px 12px",marginBottom:8,marginTop:8,background:"rgba(240,235,225,0.02)"}}>
              <div style={{display:"flex",gap:6,alignItems:"center",marginBottom:8}}>
                ...
                <button onClick={()=>removeSub(i)} style={{background:"none",border:"1px solid rgba(240,235,225,0.1)",borderRadius:3,color:"rgba(240,235,225,0.66)",width:32,height:32,flexShrink:0,cursor:"pointer",fontSize:14}}>×</button>
              </div>
              <label style={labelSt}>Ingredientes</label>
              {sp.ingredients.map((ing,j)=>(
                <div key={j} style={{display:"flex",gap:6,marginBottom:6}}>
                  ...
                  {sp.ingredients.length>1&&<button onClick={()=>removeSubItem(i,"ingredients",j)} style={{background:"none",border:"1px solid rgba(240,235,225,0.1)",borderRadius:3,color:"rgba(240,235,225,0.66)",width:32,flexShrink:0,cursor:"pointer",fontSize:14}}>×</button>}
                </div>
              ))}
              ...
              {sp.steps.map((st,j)=>(
                <div key={j} style={{display:"flex",gap:6,marginBottom:6,alignItems:"flex-start"}}>
                  ...
                  {sp.steps.length>1&&<button onClick={()=>removeSubItem(i,"steps",j)} style={{background:"none",border:"1px solid rgba(240,235,225,0.1)",borderRadius:3,color:"rgba(240,235,225,0.66)",width:32,height:32,flexShrink:0,cursor:"pointer",fontSize:14,marginTop:2}}>×</button>}
                </div>
              ))}
          ...
          <div style={{display:"flex",gap:10,marginTop:24,justifyContent:"flex-end"}}>
            <button onClick={onClose} style={{padding:"9px 20px",borderRadius:3,background:"none",border:"1px solid rgba(240,235,225,0.1)",color:"rgba(240,235,225,0.56)",cursor:"pointer",fontSize:13,fontFamily:"Archivo,sans-serif"}}>Cancelar</button>
  ...
  return (
    <div onClick={dismiss} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.78)",zIndex:9000,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 32px"}}>
      <div onClick={e=>e.stopPropagation()} style={{background:"#0F0D0A",border:`1px solid ${danger?"rgba(239,68,68,0.14)":"rgba(240,235,225,0.08)"}`,borderRadius:8,padding:"28px 22px 22px",maxWidth:300,width:"100%",boxShadow:"0 24px 60px rgba(0,0,0,0.9)",textAlign:"center"}}>
        <div style={{fontSize:13,color:"rgba(240,235,225,0.74)",fontFamily:"Archivo,sans-serif",lineHeight:1.65,marginBottom:24}}>{message}</div>
        <div style={{display:"flex",gap:8,justifyContent:"center"}}>
          {onCancel&&<button onClick={onCancel} style={{padding:"8px 20px",borderRadius:3,background:"none",border:"1px solid rgba(240,235,225,0.1)",color:"rgba(240,235,225,0.59)",fontSize:12,cursor:"pointer",fontFamily:"Archivo,sans-serif",letterSpacing:.3}}>cancelar</button>}
    ...
    <div
      ...
      <div style={{position:"absolute",top:10,left:12,right:10,display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:6}}>
        <div style={{display:"flex",flexDirection:"column",gap:3}}>
          {styleTag&&<span style={{...CARD_TYPO.tag,color:"rgba(231,224,205,0.85)",background:"rgba(0,0,0,0.52)",backdropFilter:"blur(6px)",padding:"3px 7px",borderRadius:3}}>{styleTag}</span>}
    ...
    <div className="otr-modal-backdrop" onClick={posEditMode?undefined:onClose} style={{position:"fixed",inset:0,background:posEditMode?"rgba(0,0,0,0.88)":"rgba(0,0,0,0.92)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:10000,padding:20,backdropFilter:"blur(12px)"}}>
      ...
      <div className="otr-modal-sheet" onClick={e=>e.stopPropagation()} style={{background:"#0A0906",border:`1px solid ${theme.border}22`,borderRadius:6,width:"100%",maxWidth:580,maxHeight:"90vh",overflowX:"hidden",overflowY:"auto",boxShadow:`0 32px 80px rgba(0,0,0,0.85), 0 0 40px ${theme.accent}10`,position:"relative"}}>
        ...
        {!posEditMode&&(
          <div style={{position:"absolute",top:12,right:12,display:"flex",gap:7,zIndex:40}}>
            ...
            <button onClick={onClose} aria-label="Fechar" style={{width:28,height:28,borderRadius:3,border:"1px solid rgba(240,235,225,0.12)",background:"rgba(0,0,0,0.45)",color:"rgba(240,235,225,0.64)",fontSize:15,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}}>×</button>
          </div>
        )}
          ...
          <div style={{position:"relative",height:220,zIndex:1}}>
            ...
            {posEditMode?(
              <div style={{position:"absolute",inset:0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:8,pointerEvents:"none",zIndex:5}}>
                ...
                <span style={{fontSize:9,letterSpacing:2,textTransform:"uppercase",color:"rgba(240,235,225,0.6)",fontFamily:"Archivo,sans-serif"}}>arraste para reposicionar</span>
              </div>
            ):(
        ...
        <div style={{padding:"8px 18px 32px",textAlign:"left",filter:posEditMode?"blur(2px) brightness(0.25)":"none",transition:"filter .25s",pointerEvents:posEditMode?"none":"auto"}}>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
            <div style={{display:"flex",alignItems:"baseline",gap:9}}>
              ...
              {recipe.servings&&recipe.servings!=="1"&&<span style={{fontSize:10,letterSpacing:.5,color:"rgba(240,235,225,0.55)",padding:"2px 9px",borderRadius:20,background:"rgba(240,235,225,0.05)",fontFamily:"Archivo,sans-serif"}}>rende {recipe.servings}</span>}
            </div>
          ...
          {steps.length>0?(
            ...
            <div style={{padding:"18px 0 26px",textAlign:"center",color:"rgba(240,235,225,0.63)",fontSize:13,fontStyle:"italic"}}>
                  ...
                  return(
                    <div key={si} style={{border:`1px solid ${theme.border}`,borderRadius:8,overflow:"hidden",background:"rgba(240,235,225,0.02)"}}>
                      <button onClick={()=>setOpenSub(o=>({...o,[si]:!o[si]}))} style={{width:"100%",display:"flex",alignItems:"center",gap:10,padding:"11px 13px",background:"none",border:"none",cursor:"pointer",textAlign:"left"}}>
                        ...
                        <span style={{flex:1,...CARD_TYPO.bodyText,color:"rgba(231,224,205,0.88)",fontWeight:700}}>{capFirst(sp.name)}</span>
                        <span style={{fontSize:11,color:"rgba(240,235,225,0.56)"}}>{(sp.ingredients||[]).length} ingr</span>
                      </button>
                      {isOpen&&(
                        <div style={{padding:"0 14px 14px 34px"}}>
                              ...
                              {sp.ingredients.map((ing,ii)=>{
                                ...
                                return(
                                  <div key={ii} style={{display:"flex",alignItems:"baseline",gap:8}}>
                                    {parts?(<>
                                      <span style={{...CARD_TYPO.bodyText,color:"rgba(231,224,205,0.75)"}}>{capFirst(parts.name)}</span>
                                      ...
                                      <span style={{...CARD_TYPO.bodyText,color:"rgba(231,224,205,0.75)"}}>{capFirst(ing)}</span>
                                    )}
                                  </div>
                                );
                              })}
                          ...
                          {sp.yield&&<div style={{fontSize:11,color:"rgba(240,235,225,0.6)",fontStyle:"italic",marginTop:12}}>rende {sp.yield}</div>}
                        </div>
                      )}
                    </div>
                  );
            ...
            {editingNote ? (
              <div>
                <textarea ref={noteRef} value={noteVal} onChange={e=>setNoteVal(e.target.value)} autoFocus rows={3}
                  style={{width:"100%",background:"rgba(240,235,225,0.04)",border:`1px solid ${theme.accent}44`,borderRadius:3,padding:"10px 12px",color:"rgba(240,235,225,0.71)",fontSize:13,lineHeight:1.7,fontStyle:"italic",resize:"vertical",boxSizing:"border-box",fontFamily:"Archivo,sans-serif"}}
                ...
                <div style={{display:"flex",gap:8,marginTop:6}}>
                  ...
                  <button onClick={()=>{setNoteVal(recipe.notes||"");setEditingNote(false);}} style={{padding:"5px 12px",borderRadius:3,background:"none",border:"1px solid rgba(240,235,225,0.1)",color:"rgba(240,235,225,0.66)",fontSize:11,cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>cancelar</button>
                </div>
              </div>
            ) : noteVal ? (
              ...
              <button onClick={()=>setEditingNote(true)} style={{background:"none",border:"none",padding:0,color:"rgba(240,235,225,0.57)",fontSize:11,letterSpacing:1.5,textTransform:"uppercase",cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>+ adicionar nota</button>
            )}
          </div>
          ...
          <div style={{marginTop:20,paddingTop:16,borderTop:"1px solid rgba(240,235,225,0.11)",display:"flex",flexDirection:"column",gap:8}}>
            ...
            {!confirmDelete?(
              ...
              <div style={{display:"flex",alignItems:"center",gap:10}}>
                <span style={{fontSize:12,color:"rgba(240,235,225,0.56)"}}>Tem certeza?</span>
                ...
                <button onClick={()=>setConfirmDelete(false)} style={{background:"none",border:"1px solid rgba(240,235,225,0.1)",borderRadius:3,padding:"5px 12px",color:"rgba(240,235,225,0.66)",fontSize:11,cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>cancelar</button>
              </div>
            )}
          </div>
        </div>
      ...
      <div ref={shareCardRef} style={{position:"fixed",left:-9999,top:-9999,width:360,background:"#0A0906",borderRadius:12,fontFamily:"Archivo,sans-serif",overflow:"hidden",border:`1.5px solid ${theme.accent}55`,boxShadow:`0 0 32px ${theme.accent}22`}}>
        ...
        <div style={{position:"relative",height:222,backgroundColor:"#0A0906",...buildCardBgEditorial(visual,"center")}}>
          ...
          {/* wordmark */}
          <div style={{position:"absolute",top:14,left:16,fontSize:12,letterSpacing:4,textTransform:"uppercase",fontWeight:900,fontFamily:"Archivo,sans-serif",color:"rgba(240,235,225,0.93)",textShadow:"0 1px 6px rgba(0,0,0,0.9), 0 2px 20px rgba(0,0,0,0.75)"}}>ON THE ROCKS</div>
      ...
      {sidebarTab==="família"?(
        <div style={{flex:1,overflowY:"auto"}}>
          {FAMILY_GROUPS.map(group=>{
            ...
            return(
              <div key={group.label} style={{marginBottom:18}}>
                <div style={{fontSize:8,letterSpacing:3,textTransform:"uppercase",color:"rgba(240,235,225,0.56)",fontWeight:700,marginBottom:6,paddingLeft:2}}>{group.label}</div>
                {available.map(s=>{
                  ...
                  return(
                    <button key={s} onClick={()=>{setActiveStyle(active?null:s);if(!active)setMobileTab("explorar");}} style={{display:"flex",alignItems:"center",gap:9,width:"100%",padding:"9px 11px",borderRadius:3,marginBottom:2,textAlign:"left",background:active?th.bg:"transparent",border:`1px solid ${active?th.border+"66":"transparent"}`,cursor:"pointer",transition:"all .12s",fontFamily:"Archivo,sans-serif"}}>
                      ...
                      <span style={{fontSize:10,color:"rgba(240,235,225,0.63)"}}>{count}</span>
                    </button>
                  );
                })}
              </div>
          ...
          <div style={{marginBottom:18}}>
            <div style={{fontSize:8,letterSpacing:3,textTransform:"uppercase",color:"rgba(240,235,225,0.56)",fontWeight:700,marginBottom:6,paddingLeft:2}}>Técnica</div>
          ...
          <div style={{marginBottom:18}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:6,paddingLeft:2}}>
              <div style={{fontSize:8,letterSpacing:3,textTransform:"uppercase",color:"rgba(240,235,225,0.56)",fontWeight:700}}>Ocasião</div>
              {activeOccasions.length>0&&<button onClick={()=>{setMobileTab&&setMobileTab("explorar");clearAll();}} style={{fontSize:8,color:"rgba(240,235,225,0.51)",background:"none",border:"none",cursor:"pointer",letterSpacing:1,fontFamily:"Archivo,sans-serif",padding:0}}>limpar ×</button>}
            </div>
            <div style={{display:"flex",flexWrap:"wrap",gap:5}}>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",minHeight:0}}>
          <div style={{fontSize:8,letterSpacing:3,textTransform:"uppercase",color:"rgba(240,235,225,0.56)",fontWeight:700,marginBottom:7}}>Tenho em casa</div>
          ...
          <div style={{borderTop:"1px solid rgba(240,235,225,0.11)",paddingTop:11,marginBottom:7}}>
            <div style={{fontSize:8,letterSpacing:3,textTransform:"uppercase",color:"rgba(240,235,225,0.56)",fontWeight:700,marginBottom:6}}>Filtrar por spirit</div>
          ...
          <div style={{borderTop:"1px solid rgba(240,235,225,0.11)",paddingTop:10,marginTop:8,flexShrink:0}}>
            <div style={{fontSize:8,letterSpacing:3,textTransform:"uppercase",color:"rgba(240,235,225,0.56)",fontWeight:700,marginBottom:6}}>Adicionar bebida</div>
  ...
  return(
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.68)",zIndex:10000,display:"flex",alignItems:"center",justifyContent:"center",padding:"0 28px"}} onClick={onClose}>
      <div style={{background:"#0F0D0A",border:`1px solid ${th.border}55`,borderRadius:16,padding:"28px 24px 22px",maxWidth:300,width:"100%",textAlign:"center",boxShadow:"0 32px 80px rgba(0,0,0,0.8)"}} onClick={e=>e.stopPropagation()}>
        <div style={{fontSize:8,letterSpacing:3,textTransform:"uppercase",color:"rgba(240,235,225,0.57)",fontWeight:700,marginBottom:10}}>como foi?</div>
        ...
        <button onClick={onClose} style={{background:"none",border:"none",fontSize:10,letterSpacing:2.5,textTransform:"uppercase",color:"rgba(240,235,225,0.46)",cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>fechar</button>
      </div>
    </div>
  );
}
        ...
        <div style={{display:"flex",flexDirection:"column",gap:10,width:"100%",marginTop:4}}>
          <div style={{display:"flex",gap:8,width:"100%"}}>
            {!isWelcome&&(
              <button onClick={()=>goTo(step-1)}
                style={{padding:"14px",borderRadius:4,background:"rgba(240,235,225,0.05)",border:"1px solid rgba(240,235,225,0.1)",color:"rgba(240,235,225,0.56)",fontSize:13,fontFamily:"Archivo,sans-serif",cursor:"pointer",flexShrink:0}}>
                ←
              </button>
            )}
          ...
          {!isLast&&(
            <button onClick={onClose}
              style={{padding:"10px",borderRadius:4,background:"none",border:"none",color:"rgba(240,235,225,0.46)",fontSize:12,fontFamily:"Archivo,sans-serif",cursor:"pointer"}}>
              Pular tour
            </button>
          )}
        </div>
    ...
    <div style={{paddingBottom:100}}>
            ...
            {availPacks.map((pack,i)=>(
              <div key={pack.id} style={{display:i===carouselIdx?"block":"none"}}>
                ...
                <div style={{position:"absolute",bottom:0,left:0,right:0,padding:"28px 16px 12px",background:"linear-gradient(transparent,rgba(0,0,0,0.75))",borderRadius:"0 0 14px 14px",pointerEvents:"none"}}>
                  ...
                  {pack.description&&<div style={{fontSize:11,color:"rgba(240,235,225,0.67)",marginTop:2,fontFamily:"Archivo,sans-serif"}}>{pack.description}</div>}
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
          {[
            ...
            <button key={l} onClick={()=>onGoTo(filter)}
              ...
              <div style={{...CARD_TYPO.sectionHead,color:"rgba(240,235,225,0.82)",marginTop:6}}>{l}</div>
            </button>
          ))}
        </div>
      </div>
      ...
      <div style={{marginBottom:24}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10,cursor:"pointer"}} onClick={()=>setCollectionsOpen(o=>!o)}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            <span style={{fontSize:14,lineHeight:1,color:"#A0785A",display:"inline-block",transition:"transform .35s",transform:collectionsOpen?"rotate(180deg)":"rotate(0deg)"}}>⟳</span>
            <span style={{...CARD_TYPO.sectionHead,opacity:1,color:"rgba(160,120,90,0.95)"}}>Coleções</span>
          </div>
          <div style={{display:"flex",alignItems:"center",gap:8}}>
              ...
              {accessiblePacks.length>0?(
                accessiblePacks.map((pack,i,arr)=>(
                  <button key={pack.id} onClick={()=>onGoToCollection&&onGoToCollection(pack.name)} style={{display:"flex",alignItems:"center",gap:12,padding:"13px 16px",width:"100%",background:"none",border:"none",borderBottom:i<arr.length-1?"1px solid rgba(240,235,225,0.05)":"none",cursor:"pointer",textAlign:"left",boxSizing:"border-box"}}>
                    ...
                    <div style={{color:"rgba(240,235,225,0.49)",fontSize:14,marginLeft:2}}>›</div>
                  </button>
                ))
              ):(
                <div style={{padding:"20px 16px",textAlign:"center",color:"rgba(240,235,225,0.66)",fontSize:13,fontFamily:"Archivo,sans-serif"}}>
          ...
          <div style={{borderTop:"1px solid rgba(240,235,225,0.05)"}}>
            {restoreConfirm==="recipes"?(
              <div style={{padding:"14px 16px"}}>
                <p style={{margin:"0 0 10px",...CARD_TYPO.bodyText,fontSize:12,color:"rgba(240,235,225,0.67)"}}>As receitas originais voltam ao padrão. Suas receitas criadas e avaliações são mantidas.</p>
                <div style={{display:"flex",gap:8}}>
                  ...
                  <button onClick={()=>setRestoreConfirm(null)} style={{padding:"7px 12px",borderRadius:8,background:"none",border:"1px solid rgba(240,235,225,0.1)",color:"rgba(240,235,225,0.66)",fontSize:11,cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>cancelar</button>
                </div>
              </div>
            ):(
            ...
            {restoreConfirm==="all"?(
              <div style={{padding:"14px 16px"}}>
                <p style={{margin:"0 0 10px",...CARD_TYPO.bodyText,fontSize:12,color:"rgba(240,235,225,0.67)"}}>Esta ação vai redefinir toda a experiência — receitas originais voltam ao padrão e as suas receitas criadas serão apagadas. Não dá pra desfazer.</p>
                <div style={{display:"flex",gap:8}}>
          ...
          <>
            ...
            {deleteConfirm?(
              <div style={{marginTop:8,padding:"14px 16px",borderRadius:12,background:"rgba(180,60,60,0.08)",border:"1px solid rgba(180,60,60,0.25)",backdropFilter:"blur(8px)"}}>
                <p style={{margin:"0 0 10px",fontSize:12,color:"rgba(240,235,225,0.67)",fontFamily:"Archivo,sans-serif"}}>Isso apaga permanentemente sua conta e todos os seus dados. Não tem como desfazer.</p>
                <div style={{display:"flex",gap:8}}>
                  ...
                  <button onClick={()=>setDeleteConfirm(false)} style={{padding:"7px 12px",borderRadius:8,background:"none",border:"1px solid rgba(240,235,225,0.1)",color:"rgba(240,235,225,0.66)",fontSize:11,cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>cancelar</button>
                </div>
      ...
      <div style={{marginBottom:16}}>
        ...
        <div style={{background:"rgba(0,0,0,0.3)",border:"1px solid rgba(240,235,225,0.13)",borderRadius:12,padding:"18px 18px",backdropFilter:"blur(8px)",display:"flex",flexDirection:"column",gap:12}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"baseline"}}>
            <span style={{fontFamily:"Archivo,sans-serif",fontSize:12,fontWeight:900,letterSpacing:4,textTransform:"uppercase",color:"rgba(231,224,205,0.88)"}}>ON THE ROCKS</span>
          ...
          <p style={{fontSize:12,color:"rgba(240,235,225,0.66)",fontFamily:"Archivo,sans-serif",margin:0}}>Desenvolvido por Marcelo Parducci</p>
          <div style={{display:"flex",justifyContent:"space-between",gap:8}}>
            <span style={{fontSize:10,color:"rgba(240,235,225,0.69)",fontFamily:"Archivo,sans-serif",letterSpacing:.5}}>Dados</span>
            <span style={{fontSize:10,color:"rgba(240,235,225,0.66)",fontFamily:"Archivo,sans-serif",textAlign:"right"}}>Sincronizados via Google Account</span>
          </div>
        </div>
      </div>

      <div style={{paddingTop:16,borderTop:"1px solid rgba(240,235,225,0.16)",textAlign:"center",fontSize:10,color:"rgba(240,235,225,0.69)",fontFamily:"Archivo,sans-serif",lineHeight:1.8}}>
        Conteúdo destinado a maiores de 18 anos.<br/>Beba com responsabilidade.
      </div>

      <div style={{marginTop:14,textAlign:"center",...CARD_TYPO.counter,color:"rgba(240,235,225,0.4)",letterSpacing:1}}>
        {(()=>{
...
export default function OnTheRocks(){
  ...
  useEffect(()=>{try{localStorage.setItem('otr_comanda_groups',JSON.stringify(comandaGroups));}catch{}; syncToFirestore({comandaGroups});},[comandaGroups]);
  ...
  return(
    <div style={{fontFamily:"Archivo,sans-serif",minHeight:"100vh",background:"#070707",color:"#F0EBE1",overflowX:"hidden"}}>
      ...
      <header style={{padding:"14px 22px 12px",borderBottom:"1px solid rgba(240,235,225,0.05)",display:"flex",alignItems:"center",gap:12,flexWrap:"wrap",background:"#070707",position:"sticky",top:0,zIndex:200}}>
        <button onClick={()=>{setProfileView(false);preProfileRef.current=null;setMobileTab("descobrir");setActiveStyle(null);setActiveSpirits([]);setFilterMode("tudo");setSearch("");}} style={{marginRight:"auto",lineHeight:1,background:"none",border:"none",cursor:"pointer",padding:0,textAlign:"left"}}>
          <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:2}}>
            ...
            <span style={{fontSize:9,letterSpacing:5,textTransform:"uppercase",color:"rgba(240,235,225,0.66)",fontWeight:300}}>ON THE</span>
            <div style={{height:1,width:18,background:"rgba(240,235,225,0.2)"}}/>
          </div>
        ...
        <div className="hdr-actions" style={{display:"flex",gap:6}}>
          ...
          <button onClick={exportJSON} title="Exportar" style={{padding:"7px 10px",borderRadius:3,background:"rgba(240,235,225,0.04)",border:"1px solid rgba(240,235,225,0.13)",color:"rgba(240,235,225,0.66)",fontSize:13}}>↓</button>
          <button onClick={()=>importRef.current?.click()} title="Importar" style={{padding:"7px 10px",borderRadius:3,background:"rgba(240,235,225,0.04)",border:"1px solid rgba(240,235,225,0.13)",color:"rgba(240,235,225,0.66)",fontSize:13}}>↑</button>
        </div>
      </header>
        ...
        <main ref={mainRef} className="app-main" style={{padding:"18px 22px 24px"}}>
          ...
          {mobileTab==="descobrir"&&!swipeRecipe ? (
            <div className="disc-stage" style={{position:"fixed",inset:"70px 0 65px 0",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:12,opacity:.45}}>
              ...
              <span style={{fontSize:11,letterSpacing:2,textTransform:"uppercase",color:"rgba(240,235,225,0.64)"}}>{packConfigLoaded?"nenhuma receita encontrada":"carregando…"}</span>
            </div>
          ) : mobileTab==="descobrir"&&swipeRecipe ? (
            <div className="disc-stage" style={{position:"fixed",inset:`70px 0 calc(50px + env(safe-area-inset-bottom, 8px)) 0`,display:"flex",flexDirection:"column",alignItems:"center",overflow:"hidden",touchAction:"none",backgroundColor:`${getTheme(swipeRecipe.categories).accent}06`,transition:"background-color 1.1s ease"}}>
                    ...
                    <div className="disc-card" style={{
                      ...
                      <div style={{position:"absolute",bottom:24,left:20,right:20,display:"flex",flexDirection:"column",gap:10}}>
                        <div style={{fontFamily:"'Gloock',serif",
                          ...
                          fontWeight:400,lineHeight:1.15,color:"rgba(231,224,205,0.96)",letterSpacing:"-0.3px",
              ...
              <div className="disc-controls" style={{flexShrink:0,width:"100%",display:"grid",gridTemplateColumns:"1fr 1fr 1fr",columnGap:8,padding:"6px 12px 14px",background:`radial-gradient(ellipse 100% 140% at 50% 100%, ${getTheme(swipeRecipe.categories).accent}1a 0%, ${getTheme(swipeRecipe.categories).accent}08 45%, transparent 75%)`,transition:"background 1.1s ease",position:"relative"}}>
                ...
                <div style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
                  <button onClick={()=>setFilterSheet(filterSheet==="ocasiao"?null:"ocasiao")}
                    style={{...CARD_TYPO.uiLabel,width:"100%",display:"flex",alignItems:"center",justifyContent:"center",gap:6,padding:"6px 8px",borderRadius:20,cursor:"pointer",transition:"all .2s",whiteSpace:"nowrap",
                ...
                <div style={{display:"flex",justifyContent:"center",alignItems:"center"}}>
                  <button onClick={()=>{setSwipeUnprovenOnly(v=>{const n=!v;if(n)localStorage.setItem("otr_swipe_unproven","1");else localStorage.removeItem("otr_swipe_unproven");return n;})}}
                    style={{...CARD_TYPO.uiLabel,width:"100%",display:"flex",alignItems:"center",justifyContent:"center",gap:5,padding:"6px 8px",borderRadius:20,whiteSpace:"nowrap",background:swipeUnprovenOnly?"rgba(74,222,128,0.1)":"rgba(240,235,225,0.04)",border:`1px solid ${swipeUnprovenOnly?"rgba(74,222,128,0.35)":"rgba(240,235,225,0.12)"}`,color:swipeUnprovenOnly?"#4ADE80":"rgba(240,235,225,0.35)",cursor:"pointer",transition:"all .2s"}}>
            ...
            <div style={{paddingBottom:100,display:"flex",flexDirection:"column",gap:0}}>
              ...
              <div style={{position:"relative",margin:"-18px -22px 24px",padding:"16px 24px 14px",overflow:"hidden",background:"linear-gradient(to bottom,rgba(30,16,4,0.98) 0%,rgba(8,5,1,0.99) 100%)"}}>
                ...
                <div style={{...CARD_TYPO.bodyText,fontSize:13,color:"rgba(240,235,225,0.56)",position:"relative"}}>Marque o que você tem e descubra o que pode fazer.</div>
              </div>
              ...
              <div style={{marginBottom:20,background:"rgba(0,0,0,0.28)",border:"1px solid rgba(240,235,225,0.11)",borderRadius:12,padding:"18px 16px"}}>
                <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:14}}>
                  ...
                  {owned.length>0&&<button onClick={()=>setOwned([])} style={{marginLeft:"auto",padding:"3px 10px",borderRadius:20,...CARD_TYPO.uiLabel,fontSize:10,background:"none",border:"1px solid rgba(240,235,225,0.1)",color:"rgba(240,235,225,0.57)",cursor:"pointer"}}>limpar</button>}
                </div>
                <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
                  {allSpirits.map(s=>{
              ...
              <div style={{marginBottom:24,background:"rgba(0,0,0,0.28)",border:"1px solid rgba(240,235,225,0.11)",borderRadius:12,padding:"18px 16px"}}>
                ...
                {customSpirits.length>0&&(
                  <div style={{marginTop:16,paddingTop:12,borderTop:"1px solid rgba(240,235,225,0.05)"}}>
                    <div style={{...CARD_TYPO.sectionHead,color:"rgba(240,235,225,0.53)",marginBottom:10}}>Adicionadas</div>
                    <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
                      {customSpirits.map(s=>(
                  ...
                  <div>
                    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
                      ...
                      <button onClick={()=>{setActiveSpirits(owned);setFilterAnd(filterAnd);setFilterMode("tudo");setMobileTab("explorar");}}
                        style={{...CARD_TYPO.uiLabel,color:"rgba(240,235,225,0.53)",background:"none",border:"none",cursor:"pointer"}}>
                        ver todos →
                      </button>
                    </div>
                    <div style={{display:"flex",flexDirection:"column",gap:8}}>
            ...
            <div style={{paddingBottom:100}}>
              ...
              <div style={{marginBottom:16}}>
                <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:4}}>
                  ...
                  <div style={{display:"flex",gap:6}}>
                    ...
                    {comanda.length>0&&!comandaReorder&&(
                      <button onClick={()=>{setComanda([]);setComandaGroups(p=>p.map(g=>({...g,drinks:[]})));}} style={{padding:"3px 10px",borderRadius:20,fontSize:10,background:"none",border:"1px solid rgba(240,235,225,0.13)",color:"rgba(240,235,225,0.66)",cursor:"pointer",fontFamily:"Archivo,sans-serif",letterSpacing:.5}}>limpar</button>
                    )}
                  </div>
                </div>
                {showNewGroupInput&&(
                ...
                <div style={{fontSize:13,color:"rgba(240,235,225,0.6)",lineHeight:1.5,marginTop:6}}>Os drinks que você quer pedir na próxima noite.</div>
              </div>
              {comanda.length===0?(
                <div style={{textAlign:"center",padding:"80px 0",color:"rgba(240,235,225,0.53)"}}>
                ...
                const btnBase={background:"rgba(0,0,0,0.5)",border:"1px solid rgba(240,235,225,0.15)",borderRadius:3,width:26,height:22,color:"rgba(240,235,225,0.63)",cursor:"pointer",fontSize:11,lineHeight:1,display:"flex",alignItems:"center",justifyContent:"center"};
                const renderCard=r=>{
                    ...
                    <div key={r.name}
                      ...
                      <div style={{position:"absolute",top:10,left:14,right:10,display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:6}}>
                        <div style={{display:"flex",gap:7,alignItems:"center"}}>
                          {styleTag&&<span style={CARD_TYPO.tag}>{styleTag}</span>}
                          {spiritTag&&<><span style={{...CARD_TYPO.tag,color:th.accent,opacity:.3}}>·</span><span style={{...CARD_TYPO.tag,color:"rgba(240,235,225,0.57)"}}>{spiritTag}</span></>}
                        </div>
                        ...
                        <div key={group.id}>
                          <div style={{...groupHeaderSt,justifyContent:"space-between"}}>
                            <div style={{display:"flex",alignItems:"center",gap:8,flex:1,minWidth:0}} onClick={()=>toggleGroupCollapse(group.id)}>
                              ...
                              <span style={{fontSize:10,color:"rgba(240,235,225,0.53)",flexShrink:0}}>{gDrinks.length}</span>
                            </div>
                            <div style={{display:"flex",gap:4,flexShrink:0}}>
                              <button onClick={e=>{e.stopPropagation();setEditGroupId(group.id);setEditGroupName(group.name);}} style={{background:"none",border:"none",color:"rgba(240,235,225,0.53)",cursor:"pointer",fontSize:13,padding:"2px 4px"}}>✎</button>
            ...
            <>
              ...
              <div className="mnv" style={{display:"none",position:"relative",marginBottom:10,zIndex:99}}>
                <div style={{display:"flex",gap:6,flexWrap:"wrap",paddingBottom:4}}>
                  ...
                  {(activeStyle||activeSpirits.length||filterMode!=="tudo"||activeOccasions.length>0||activePack)&&(
                    <button onClick={clearAll} style={{...CARD_TYPO.uiLabel,padding:"8px 16px",borderRadius:20,flexShrink:0,cursor:"pointer",background:"none",border:"1px solid rgba(240,235,225,0.13)",color:"rgba(240,235,225,0.51)"}}>limpar</button>
                  )}
                </div>
              ...
              {activeStyle&&FAMILY_DESC[activeStyle]&&(
                <div className="mnv" style={{marginBottom:14,padding:"12px 14px",borderRadius:6,background:`${(TYPE_THEME[activeStyle]||TYPE_THEME["_default"]).bg}cc`,border:`1px solid ${(TYPE_THEME[activeStyle]||TYPE_THEME["_default"]).border}44`}}>
                  ...
                  <p style={{margin:0,fontSize:12,color:"rgba(240,235,225,0.71)",lineHeight:1.65}}>{FAMILY_DESC[activeStyle]}</p>
                </div>
              )}              {/* mobile: busca */}
              ...
              {(filterMode==="favs"||filterMode==="provados"||filterMode==="custom")&&(
                <div style={{fontFamily:"'Gloock',serif",fontSize:28,fontWeight:400,color:"rgba(231,224,205,0.93)",letterSpacing:"-0.3px",marginBottom:20,lineHeight:1.2}}>
                  {filterMode==="favs"?"Favoritas":filterMode==="provados"?"Provadas":"Minhas Receitas"}
                </div>
              )}
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16}}>
                <span style={{...CARD_TYPO.sectionHead,color:"rgba(240,235,225,0.56)"}}>
              ...
              {filtered.length===0?(
                <div style={{textAlign:"center",padding:"80px 0",color:"rgba(240,235,225,0.66)"}}>
      ...
      {/* ── TELA COLEÇÕES ── */}
      {collectionsView&&(
        <div className="otr-modal-backdrop" onClick={()=>setCollectionsView(false)} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.92)",zIndex:10004,display:"flex",alignItems:"center",justifyContent:"center",padding:16,backdropFilter:"blur(12px)"}}>
          <div className="otr-modal-sheet" onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:540,maxHeight:"90vh",display:"flex",flexDirection:"column",background:"#070707",overflowY:"auto",overflowX:"hidden",borderRadius:16,border:"1px solid rgba(200,169,110,0.18)",boxShadow:"0 32px 80px rgba(0,0,0,0.85)",paddingBottom:16}}>
            {/* header */}
            <div style={{position:"sticky",top:0,zIndex:10,background:"rgba(7,7,7,0.96)",backdropFilter:"blur(12px)",padding:"16px 20px 14px",borderBottom:"1px solid rgba(240,235,225,0.07)",display:"flex",alignItems:"center",gap:14}}>
              <button onClick={()=>setCollectionsView(false)} style={{background:"none",border:"none",color:"rgba(240,235,225,0.63)",cursor:"pointer",fontSize:20,lineHeight:1,padding:"0 4px",display:"flex",alignItems:"center"}}>‹</button>
            ...
            <div style={{padding:"24px 20px 0"}}>
                    ...
                    {accessiblePacks.filter(pk=>(pk.recipeNames||[]).length>0).map(pk=>{
                      ...
                      <div key={pk.id} style={{background:"rgba(0,0,0,0.3)",border:`1px solid ${activePack===pk.name?"rgba(160,120,90,0.45)":"rgba(240,235,225,0.1)"}`,borderRadius:12,overflow:"hidden",transition:"border-color .15s"}}>
                        ...
                        <div style={{padding:"12px 16px"}}>
                          {pkSpirits.length>0&&<div style={{fontSize:10,letterSpacing:1,textTransform:"uppercase",color:"rgba(160,120,90,0.7)",fontFamily:"Archivo,sans-serif",marginBottom:9,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{pkSpirits.join(" · ")}</div>}
                          <div style={{display:"flex",alignItems:"center",gap:10}}>
                            <div style={{flex:1,fontSize:10,letterSpacing:1.5,textTransform:"uppercase",color:"rgba(240,235,225,0.53)",fontFamily:"Archivo,sans-serif"}}>{(pk.recipeNames||[]).length} drinks</div>
              ...
              {!devMode&&accessiblePacks.length===0&&availPacks.filter(p=>!unlockedPacks.includes(p.id)).length===0&&(
                <div style={{textAlign:"center",padding:"40px 0",color:"rgba(240,235,225,0.53)",fontSize:13,fontFamily:"Archivo,sans-serif"}}>Nenhuma coleção disponível no momento.</div>
              )}
            </div>
          </div>
        </div>
      ...
      {infoPackId&&(()=>{
        ...
        return(
          <div className="otr-modal-backdrop" onClick={()=>setInfoPackId(null)} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.95)",zIndex:10005,display:"flex",alignItems:"center",justifyContent:"center",padding:16,backdropFilter:"blur(16px)"}}>
            <div className="otr-modal-sheet" onClick={e=>e.stopPropagation()} style={{width:"100%",maxWidth:540,maxHeight:"90vh",display:"flex",flexDirection:"column",background:"#070707",overflowY:"auto",overflowX:"hidden",borderRadius:16,border:"1px solid rgba(200,169,110,0.18)",boxShadow:"0 32px 80px rgba(0,0,0,0.85)",paddingBottom:16}}>
              {/* header */}
              <div style={{position:"sticky",top:0,zIndex:10,background:"rgba(7,7,7,0.96)",backdropFilter:"blur(12px)",padding:"16px 20px 14px",borderBottom:"1px solid rgba(240,235,225,0.07)",display:"flex",alignItems:"center",gap:14}}>
                <button onClick={()=>setInfoPackId(null)} style={{background:"none",border:"none",color:"rgba(240,235,225,0.63)",cursor:"pointer",fontSize:20,lineHeight:1,padding:"0 4px",display:"flex",alignItems:"center"}}>‹</button>
              ...
              <div style={{padding:"24px 20px"}}>
                ...
                {pk.description&&(
                  <div style={{marginBottom:20}}>
                    <div style={{fontSize:8,letterSpacing:3,textTransform:"uppercase",color:"rgba(240,235,225,0.53)",fontFamily:"Archivo,sans-serif",fontWeight:700,marginBottom:8}}>Sobre</div>
                    <p style={{margin:0,fontSize:14,color:"rgba(240,235,225,0.71)",lineHeight:1.7,fontFamily:"Archivo,sans-serif"}}>{pk.description}</p>
                  </div>
                )}
                {/* meta */}
                <div style={{display:"flex",gap:16,marginBottom:28}}>
                  <div style={{textAlign:"center"}}>
                    ...
                    <div style={{fontSize:9,letterSpacing:2,textTransform:"uppercase",color:"rgba(240,235,225,0.53)",fontFamily:"Archivo,sans-serif"}}>drinks</div>
                  </div>
                  {!isOwned&&pk.price>0&&(
                    <div style={{textAlign:"center"}}>
                      <div style={{fontFamily:"'Gloock',serif",fontSize:22,color:"rgba(231,224,205,0.92)"}}>R$ {Number(pk.price).toFixed(2)}</div>
                      <div style={{fontSize:9,letterSpacing:2,textTransform:"uppercase",color:"rgba(240,235,225,0.53)",fontFamily:"Archivo,sans-serif"}}>valor</div>
                    </div>
                  )}
                </div>
                {/* ação */}
