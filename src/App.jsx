...
const BASE_RECIPES = [
  ...
  // ── RUM ──
  {name:"El Presidente",categories:["Rum","Triple Sec","Cocktail","Stirred"],ingredients:["60 ml rum dourado","30 ml vermute branco","15 ml Cointreau","1 dash grenadine","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Expresse a casca de laranja."],notes:"Clássico cubano dos anos 1920.",rating:0,servings:"",custom:false},
