...
const BASE_RECIPES = [
  ...
  {name:"Bourbon, laranja e gengibre",categories:["Whisky","Triple Sec","Built"],ingredients:["60 ml bourbon","15 ml Triple Sec","15 ml xarope de gengibre","60 ml suco de laranja","gelo esmagado"],steps:["Combine tudo num copo alto com gelo esmagado.","Mexa suavemente e sirva."],notes:"",rating:0,servings:"1",custom:false},
  ...
  {name:"Névoa Verde",categories:["Gim","Sour","Shaken"],ingredients:["45 ml gin","30 ml Cordial de Pêra Assada","10 ml suco de limão"],steps:["Combine tudo na coqueteleira com gelo.","Bata bem.","Coe em coupe."],notes:"Aquele drink que você não entende, mas quer outro. Pera assada + ervas do gin + limão = sutileza em camadas.",rating:0,servings:"1",custom:false},
  ...
  {name:"Margarita Picante de Pepino",categories:["Tequila","Sour","Shaken"],ingredients:["45 ml tequila","15 ml Licor de pimenta (Ancho Reyes)","15 ml xarope de agave","30 ml suco de limão taiti","22 ml suco de pepino","borda de tajin"],steps:["Prepare a borda com tajin.","Combine tudo na coqueteleira com gelo.","Agite por 15s.","Coe em rocks com gelo."],notes:"Licor de pimenta (Ancho Reyes) no lugar do licor de laranja — pimenta e notas defumadas. O pepino refresca e equilibra o calor.",rating:0,servings:"1",custom:false},
...
function getMood(recipe) {
  ...
  if (has("Whisky","Whisky","Conhaque","Mezcal"))                                   return "smoked_amber";
...
const RECIPE_PROFILES = {
  ...
  "Gim Fizz":{"flavors":"Cítrico • Botânico • Refrescante","perfil":"Clássico","perfil_desc":"Elegância fizz londrino","sensacao":"Efervescente","sensacao_desc":"Borbulhas dançantes","ocasiao":"Início de noite","ocasiao_desc":"Tarde social ensolarada"},
  ...
  "Lillet & Gim Highball":{"flavors":"Floral • Cítrico • Herbal","perfil":"Refinado","perfil_desc":"Elegante e sofisticado","sensacao":"Fresco","sensacao_desc":"Efervescente e leve","ocasiao":"Início de noite","ocasiao_desc":"Início de noite"},
