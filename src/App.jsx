...
const BASE_RECIPES = [
  ...
  // ── VODKA ──
  {name:"Vesper",categories:["Gim","Vodka","Stirred"],ingredients:["60 ml gin","20 ml vodka","10 ml Lillet Blanc","casca de limão"],steps:["Mexa todos com gelo.","Coe em coupe gelado.","Expresse a casca de limão."],notes:"Criado por Ian Fleming em Casino Royale.",rating:0,servings:"",custom:false},
          ...
          {mobileTab==="descobrir"&&!swipeRecipe ? (
            ...
            <>
              ...
              {filtered.length===0?(
                ...
                <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(175px,1fr))",gap:8,paddingBottom:80}}>
