...
const BASE_RECIPES = [
  ...
  {name:"Negroni",categories:["Gim","Campari","Vermute Rosso","Stirred"],ingredients:["30 ml Gim","30 ml Campari","30 ml Vermute tinto"],steps:["Adicione gelo no copo.","Adicione os três ingredientes em partes iguais.","Mexa e decore com casca de laranja."],notes:"",rating:0,servings:"1",custom:false},
  ...
  // ── CAMPARI MODERNO ──
  {name:"Jardim Suspenso",categories:["Gim","Campari","Collins","Built"],ingredients:["40 ml Campari","20 ml gin","15 ml cordial de pepino (ou suco fresco)","10 ml suco de limão siciliano","soda para completar","folha de manjericão"],steps:["Esmague levemente o manjericão no copo.","Adicione gelo, Campari, gin, pepino e limão.","Complete com soda."],notes:"O Campari vira folha amarga em vez de casca cítrica. Verde e elegante.",rating:0,servings:"1",custom:false},
