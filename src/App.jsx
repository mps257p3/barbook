...
const BASE_RECIPES = [
  ...
  {name:"White Russian de abóbora",categories:["Vodka","Cocktail","Built"],ingredients:["60 ml vodka","60 ml Kahlúa","30 ml creme de leite batido com geleia de abóbora"],steps:["Coloque gelo num copo rocks.","Despeje a vodka e o Kahlúa sobre o gelo.","Bata levemente o creme com a geleia de abóbora e despeje por cima, deixando flutuante."],notes:"",rating:0,servings:"",custom:false},
  ...
  return(
    <div
      ...
      <div>
        ...
        <div style={{fontSize:10,color:"rgba(240,235,225,0.52)",lineHeight:1.65,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>
