...
const OCCASION_TAGS = {
  ...
  "Caipirinha":["Clássicos","Churrasco","Piscina"],"Caipirinha Clássica":["Clássicos","Churrasco","Descomplicado","Piscina","Refrescante"],"Caipirinha com Rapadura":["Introspectivo","Reconfortante","Inesperados","Churrasco"],"Caipirinha de Limão-Cravo":["Refrescante","A dois","Inesperados"],"Caipirinha de Três Limões":["Refrescante","Festa","Piscina"],"Caipirinha de Maracujá e Limão":["Refrescante","Piscina","Tropical"],"Caipirinha de Limão-Cravo e Mel":["Reconfortante","Introspectivo","A dois"],"Caipirinha de Abacaxi Tostado":["Inesperados","Churrasco","Piscina"],"Caipirinha de Cambuci":["Inesperados","Introspectivo","Refrescante"],"Caipirinha de Limão-Siciliano e Capim-Santo":["Refrescante","A dois","Piscina"],"Caipirinha de Tangerina Verde e Salina":["Refrescante","Descomplicado","Piscina"],"Caipirinha de Caju e Mel":["Refrescante","Tropical","Churrasco"],"Caipirinha de Maracujá e Kaffir":["Inesperados","Complexo","A dois"],"Caipirinha de Uva Verde":["Introspectivo","Inesperados","A dois"],"Caipirinha de Limão-Cravo, Mel e Gengibre":["Reconfortante","Introspectivo","Inesperados"],"Caipirinha de Caju Clássica":["Refrescante","Churrasco","Tropical"],"Caju com Limão-Cravo":["Refrescante","A dois","Inesperados"],"Caju, Salina e Pimenta-Rosa":["Inesperados","Complexo","Churrasco"],"Caju Tostado":["Introspectivo","Inesperados","Reconfortante"],"Caju e Louro":["Inesperados","Complexo","Introspectivo"],"Caju e Coco Seco":["Inesperados","Tropical","Piscina"],"Caju Vínico":["Complexo","Introspectivo","A dois","Inesperados"],"Caipirinha de Caju com Rum de Coco":["Tropical","Piscina","Festa","Inesperados"],
  ...
  "Maracujá Tônico":["Refrescante","Piscina","Descomplicado"],"Gold Passion":["Reconfortante","A dois","Tropical","Inesperados"],"Passo Solar":["Refrescante","Churrasco","Piscina"],"Névoa Tropical":["Introspectivo","Inesperados","A dois"],"Jardim Amarelo":["A dois","Introspectivo","Refrescante"],"Eclipse Tropical":["Introspectivo","Inesperados","A dois"],"Maracujá Amargo":["Refrescante","Churrasco","Inesperados"],"Linha do Equador":["Tropical","Piscina","Inesperados"],"Pornstar Martini":["Festa","A dois","Tropical"],"Saturn":["Complexo","Tropical","Inesperados","Festa"],"Hurricane":["Festa","Tropical","Piscina"],"Cobra's Fang":["Complexo","Tropical","Inesperados"],"Passion Fruit Margarita":["Refrescante","Churrasco","Piscina","Tropical"],"Whiskey Sour de Maracujá":["A dois","Reconfortante","Tropical","Inesperados"],
  "Highball de Cajuína":["Refrescante","Descomplicado","Churrasco"],"Gin & Cajuína":["Refrescante","Piscina","Descomplicado"],"Rabo de Galo com Cajuína":["Introspectivo","A dois","Inesperados"],"Cajuína & Mezcal":["Introspectivo","Inesperados","Churrasco"],"Spritz de Cajuína":["Refrescante","Piscina","Festa","Baixo álcool"],"Cajuína Noturna":["Introspectivo","Reconfortante","Inesperados"],"Cajuína Old Fashioned":["Reconfortante","Introspectivo","Inesperados"],"Tequila & Cajuína":["Refrescante","Churrasco","Piscina"],
...
const BASE_RECIPES = [
  ...
  {name:"Bourbon, laranja e gengibre",categories:["Whisky","Built"],ingredients:["60 ml bourbon","15 ml Triple Sec","15 ml xarope de gengibre","60 ml suco de laranja","gelo esmagado"],steps:["Combine tudo num copo alto com gelo esmagado.","Mexa suavemente e sirva."],notes:"",rating:0,servings:"1",custom:false},
  {name:"Bramble",categories:["Gim","Sour","Shaken"],ingredients:["45 ml gin","30 ml suco de limão siciliano","1 col. chá açúcar","20 ml licor de amora"],steps:["Bata o gim, limão e açúcar com gelo e coe num copo cheio de gelo.","Despeje o licor de amora por cima.","Decore com amora, limão e hortelã."],notes:"Servir em Double old-fashioned",rating:0,servings:"1",custom:false},
  ...
  {name:"Garden Gim",categories:["Gim","Smash","Shaken"],ingredients:["60 ml gim","50 ml xarope de manjericão","30 ml suco de limão","60 ml suco de pepino","manjericão fresco para decorar"],steps:["Prepare o xarope: água + açúcar 1:1, fervente, desligue e infuse manjericão por 30 min.","Combine gim, xarope, limão e suco de pepino na coqueteleira com gelo.","Agite bem e coe. Decore com manjericão."],notes:"",rating:0,servings:"1",custom:false},
  ...
  {name:"French 75",categories:["Espumante","Fizz","Gim","Shaken"],ingredients:["30 ml gim","15 ml suco de limão","15 ml xarope simples","champagne para completar"],steps:["Combine gim, limão e xarope na coqueteleira com gelo.","Agite e coe em taça flute.","Complete com champagne."],notes:"Cítrico, seco e sofisticado. Prosecco funciona e resulta num perfil mais frutado — champagne traz mais mineralidade e acidez fina.",rating:0,servings:"1",custom:false},
  ...
  {name:"Manhattan",categories:["Luxardo Maraschino","Vermute Rosso","Whisky","Stirred"],ingredients:["60 ml whisky de centeio","30 ml vermute tinto doce","2 dashes bitter","cereja para decorar"],steps:["Mexa com gelo em copo misturador.","Coe em taça de coquetel.","Decore com cereja."],notes:"",rating:0,servings:"",custom:false},
  {name:"Manhattan (Perfect)",categories:["Vermute Bianco","Vermute seco","Whisky","Stirred"],ingredients:["60 ml whisky de centeio","15 ml vermute seco","15 ml vermute doce","2 dashes bitter","cereja e limão para decorar"],steps:["Mexa com gelo. Coe em taça. Decore."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Martinez",categories:["Gim","Luxardo Maraschino","Vermute Rosso","Stirred"],ingredients:["45 ml gim","45 ml Vermute rosso","5 ml Luxardo Maraschino","2 dashes Angostura"],steps:["Mexa com gelo e coe."],notes:"O ancestral direto do Martini.",rating:0,servings:"",custom:false},
  ...
  {name:"Negroni",categories:["Campari","Gim","Vermute Rosso","Stirred"],ingredients:["30 ml Gim","30 ml Campari","30 ml Vermute tinto"],steps:["Adicione gelo no copo.","Adicione os três ingredientes em partes iguais.","Mexa e decore com casca de laranja."],notes:"",rating:0,servings:"1",custom:false},
  ...
  {name:"Verde Urbano",categories:["Pisco","Highball","Built"],ingredients:["50 ml pisco","15 ml suco de limão siciliano","10 ml xarope simples","folhas de manjericão","água tônica"],steps:["Macere levemente o manjericão.","Adicione pisco, limão e xarope.","Complete com tônica."],notes:"Herbal, fresco, meio coquetel de jardim depois da chuva.",rating:0,servings:"",custom:false},
  ...
  {name:"Whiskey Sour",categories:["Whisky","Sour","Shaken"],ingredients:["60 ml whisky","30 ml suco de lima","22 ml xarope simples","1 clara de ovo","alecrim tostado"],steps:["Agite com gelo. Coe em rocks cheio de gelo.","Decore com cereja."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Boulevardier",categories:["Campari","Whisky","Vermute Rosso","Stirred"],ingredients:["45 ml bourbon","30 ml Campari","30 ml vermute tinto doce"],steps:["Mexa tudo com gelo por 30s.","Coe em taça ou rocks. Decore com laranja."],notes:"O Negroni com bourbon. Mais encorpado e quente.",rating:0,servings:"",custom:false},
  ...
  {name:"Caipirinha de Limão-Cravo",categories:["Cachaça","Smash","Built"],ingredients:["1 limão-cravo pequeno","1/2 limão tahiti","10 ml xarope demerara","60 ml cachaça branca","gelo"],steps:["Macere os limões com o xarope.","Adicione gelo e cachaça.","Mexa bem."],notes:"O tahiti segura o frescor ácido; o cravo traz perfume e profundidade. Upgrade: 1 folha pequena de tangerina batida na mão.",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Três Limões",categories:["Cachaça","Smash","Built"],ingredients:["1/2 limão tahiti","1/2 limão siciliano","1/4 limão-cravo","10 ml xarope simples","60 ml cachaça","gelo"],steps:["Macere os três limões com o xarope.","Adicione gelo e cachaça.","Mexa bem."],notes:"",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Maracujá e Limão",categories:["Cachaça","Smash","Built"],ingredients:["polpa de 1/2 maracujá pequeno","1/2 limão tahiti","7 ml xarope de mel","60 ml cachaça branca","gelo"],steps:["Macere o limão com o xarope.","Adicione a polpa de maracujá.","Adicione gelo e cachaça.","Mexa bem."],notes:"O limão é essencial — sem ele o maracujá fica pesado. 1 gota de solução salina faz o maracujá brilhar.",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Limão-Cravo e Mel",categories:["Cachaça","Smash","Built"],ingredients:["1 limão-cravo","7 ml de mel leve diluído em água quente","60 ml cachaça","gelo"],steps:["Macere o limão-cravo com o mel diluído.","Adicione gelo e cachaça.","Mexa bem."],notes:"Combina muito com cachaças de amburana. Floral, quente, cítrica, quase outonal.",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Abacaxi Tostado",categories:["Cachaça","Smash","Built"],ingredients:["3 cubos de abacaxi tostado","1/2 limão tahiti","10 ml xarope demerara","60 ml cachaça","gelo"],steps:["Doure cubos de abacaxi em frigideira seca até caramelizar levemente.","Macere o abacaxi tostado com o limão e o xarope.","Adicione gelo e cachaça.","Mexa bem."],notes:"O tostado cria profundidade e reduz a sensação de suquinho.",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Cambuci",categories:["Cachaça","Smash","Built"],ingredients:["cambuci fresco","1/2 limão tahiti","xarope simples a gosto","60 ml cachaça branca mineral","gelo"],steps:["Macere o cambuci com o limão e o xarope.","Adicione gelo e cachaça.","Mexa bem."],notes:"Absurdamente paulista. Perfil verde, ácido, herbal, quase vínico. Fica maravilhosa com cachaça branca mineral.",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Limão-Siciliano e Capim-Santo",categories:["Cachaça","Smash","Built"],ingredients:["1/2 limão siciliano","1 pedaço pequeno de capim-santo","10 ml xarope simples","60 ml cachaça branca mineral","gelo"],steps:["Amasse muito levemente o capim-santo — só para acordar os óleos, não macere como hortelã.","Macere o limão com o xarope.","Adicione o capim-santo, gelo e cachaça.","Mexa bem."],notes:"Cítrica, herbal, elegante. Quase spa brasileiro sofisticado.",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Tangerina Verde e Salina",categories:["Cachaça","Smash","Built"],ingredients:["1/2 tangerina verde (mais ácida)","1/4 limão tahiti","8 ml xarope simples","60 ml cachaça","2 gotas de solução salina","gelo"],steps:["Macere a tangerina e o limão com o xarope.","Adicione gelo e cachaça.","Finalize com as gotas de salina.","Mexa bem."],notes:"A salina reduz o amargor, aumenta a suculência e faz a tangerina brilhar. Cara de varanda no fim da tarde.",rating:0,servings:"1",custom:false},
  ...
  {name:"Caipirinha de Maracujá e Kaffir",categories:["Cachaça","Smash","Built"],ingredients:["polpa de 1/2 maracujá","1/2 limão tahiti","1 folha de kaffir","7 ml xarope demerara","60 ml cachaça","gelo"],steps:["Bata a folha de kaffir na palma da mão.","Macere o limão com o xarope.","Adicione o maracujá, a folha e o gelo.","Adicione a cachaça e mexa bem."],notes:"Só bater a folha na mão já perfuma tudo. Cítrico profundo, floral, verde, muito aromático.",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Uva Verde",categories:["Cachaça Envelhecida","Smash","Built"],ingredients:["6 uvas verdes","1/3 limão siciliano","50 ml cachaça envelhecida","5 ml xarope simples","gelo"],steps:["Macere as uvas com o limão e o xarope.","Adicione gelo e cachaça envelhecida.","Mexa bem."],notes:"Melhor com madeira de carvalho, amendoim ou bálsamo. Seco, elegante, quase vinho branco aromático.",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Limão-Cravo, Mel e Gengibre",categories:["Cachaça","Smash","Built"],ingredients:["1 limão-cravo","1 rodela fina de gengibre","7 ml mel diluído","60 ml cachaça","gelo"],steps:["Macere o limão-cravo com o mel diluído.","Adicione o gengibre com moderação — só para aquecer o fundo.","Adicione gelo e cachaça.","Mexa bem."],notes:"O gengibre entra muito pouco — só como aquecimento de fundo. Quente, cítrica, perfumada, quase uma caipirinha de noite fria.",rating:0,servings:"1",custom:false},
  {name:"Caipirinha de Caju Clássica",categories:["Cachaça","Smash","Built"],ingredients:["1/2 caju maduro","1/2 limão tahiti","8 ml xarope demerara","60 ml cachaça branca","gelo"],steps:["Macere o limão primeiro com o xarope.","Adicione o caju por último, bem levemente.","Adicione gelo e cachaça.","Mexa bem."],notes:"Macere o limão primeiro, o caju entra depois. Fresco, tropical seco, adulto, muito brasileiro.",rating:0,servings:"1",custom:false},
  ...
  {name:"Névoa Tropical",categories:["Mezcal","Sour","Shaken"],ingredients:["40 ml mezcal","15 ml polpa de maracujá","10 ml limão-cravo","7 ml mel diluído","pitada de sal"],steps:["Combine no shaker com gelo.","Shake e coe duplo em coupe."],notes:"O defumado corta o lado 'suquinho' do maracujá. Misterioso, tropical seco e sofisticado.",rating:0,servings:"1",custom:false},
  {name:"Jardim Amarelo",categories:["Gin","Sour","Shaken"],ingredients:["30 ml gin","20 ml vermute branco seco","15 ml polpa de maracujá","10 ml limão siciliano"],steps:["Combine no shaker com gelo.","Shake e coe duplo em coupe."],notes:"Floral, vínico e delicado. Quase cheiro de jardim depois da chuva.",rating:0,servings:"1",custom:false},
  {name:"Eclipse Tropical",categories:["Rum Envelhecido","Shaken"],ingredients:["40 ml rum envelhecido","20 ml café frio forte","15 ml polpa de maracujá","5 ml xarope demerara"],steps:["Combine no shaker com gelo.","Shake e coe duplo em coupe."],notes:"O ácido do maracujá ilumina o café. Tostado, ácido e exótico — noturno.",rating:0,servings:"1",custom:false},
  ...
  {name:"Whiskey Sour de Maracujá",categories:["Bourbon","Sour","Shaken"],ingredients:["50 ml bourbon","15 ml polpa de maracujá","20 ml limão tahiti","10 ml mel diluído","clara de ovo (opcional)"],steps:["Dry shake sem gelo se usar clara.","Shake com gelo.","Coe duplo em coupe."],notes:"Sedoso, ácido e quente. O maracujá entra como par natural da baunilha e da madeira do bourbon.",rating:0,servings:"1",custom:false},
  ...
  {name:"Spritz de Cajuína",categories:["Campari","Spritz"],ingredients:["30 ml Aperol","60 ml cajuína","60 ml espumante brut","soda (opcional)"],steps:["Monte na taça com bastante gelo.","Adicione Aperol, cajuína e espumante.","Complete com soda se desejar."],notes:"Bitter tropical, efervescente e leve. Perfeito para fim de tarde.",rating:0,servings:"1",custom:false},
  {name:"Cajuína Noturna",categories:["Rum Envelhecido","Built"],ingredients:["40 ml rum envelhecido","30 ml café frio forte","40 ml cajuína","1 dash Angostura"],steps:["Monte diretamente no copo com gelo.","Adicione rum, café, cajuína e Angostura.","Mexa suavemente."],notes:"Tostado, vínico, seco e muito adulto. A cajuína amarra os sabores de café e rum.",rating:0,servings:"1",custom:false},
  ...
  {name:"Spiced Cane",categories:["Cachaça Envelhecida","Sour","Shaken"],ingredients:["50 ml cachaça envelhecida","20 ml xarope de gengibre","10 ml suco de limão"],steps:["Combine tudo na coqueteleira com gelo.","Agite por 12s.","Coe em coupe ou sirva em rocks com gelo."],notes:"Picante + madeira = combo muito aromático e quente.",rating:0,servings:"",custom:false},
  ...
  // ── RUM ──
  {name:"El Presidente",categories:["Rum Envelhecido","Triple Sec","Stirred"],ingredients:["60 ml rum dourado","30 ml vermute branco","15 ml Cointreau","1 dash grenadine","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Expresse a casca de laranja."],notes:"Clássico cubano dos anos 1920.",rating:0,servings:"",custom:false},
  {name:"Planter's Punch",categories:["Rum Envelhecido","Highball","Built"],ingredients:["60 ml rum escuro","30 ml suco de limão","20 ml grenadine","soda para completar","dash de Angostura"],steps:["Combine rum, limão e grenadine em copo alto com gelo.","Complete com soda.","Dash de Angostura por cima."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Mary Pickford",categories:["Rum Branco","Luxardo Maraschino","Tiki","Shaken"],ingredients:["60 ml rum branco","60 ml suco de abacaxi","15 ml Maraschino","1 dash grenadine"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"Clássico da Era Proibição, Cuba.",rating:0,servings:"",custom:false},
  ...
  {name:"Hanky Panky",categories:["Gim","Fernet","Stirred"],ingredients:["45 ml gim","45 ml vermute doce","7 ml Fernet-Branca","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Expresse a casca de laranja."],notes:"Criado por Ada Coleman, Savoy Hotel, 1925.",rating:0,servings:"",custom:false},
  ...
  {name:"Toronto",categories:["Whisky","Fernet","Stirred"],ingredients:["60 ml whisky de centeio","15 ml Fernet-Branca","5 ml xarope simples","1 dash Angostura","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Expresse a casca."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Spiced Nightcap",categories:["Drambuie","Conhaque","Stirred"],ingredients:["40 ml Drambuie","20 ml conhaque","10 ml creme de cacau","1 dash bitters"],steps:["Mexa tudo com gelo.","Sirva em taça pequena ou coupe."],notes:"Meio bombom adulto derretido, meio digestivo elegante. Para terminar a noite.",rating:0,servings:"1",custom:false},
  ...
  {name:"Citrus Cloud",categories:["Vodka","St‑Germain","Sour","Shaken"],ingredients:["35 ml vodka","25 ml St-Germain","20 ml suco de limão siciliano","10 ml xarope de mel leve","15 ml clara de ovo"],steps:["Dry shake sem gelo por 15s.","Adicione gelo e agite novamente.","Coe duplo em coupe."],notes:"O floral vira espuma aromática — o cheiro vem antes do gole.",rating:0,servings:"1",custom:false},
  {name:"Vinho de Jardim",categories:["Vinho","St‑Germain","Spritz","Built"],ingredients:["60 ml vinho branco seco","20 ml St-Germain","10 ml verjus (ou limão suave)","10 ml xarope simples","água com gás para completar"],steps:["Coloque gelo num copo de vinho.","Adicione os ingredientes líquidos.","Complete com água com gás e mexa suavemente."],notes:"Parece um spritz alternativo, mas com cara de vinho aromatizado artesanal.",rating:0,servings:"1",custom:false},
  {name:"Chá da Tarde",categories:["Gim","St‑Germain","Highball","Built"],ingredients:["40 ml gin","20 ml St-Germain","40 ml chá verde frio","10 ml suco de limão","5 ml xarope simples"],steps:["Coloque gelo num copo alto.","Adicione todos os ingredientes.","Mexa suavemente."],notes:"O chá segura o floral e dá estrutura. Fica adulto, não perfumaria.",rating:0,servings:"1",custom:false},
  ...
  {name:"Estufa",categories:["Gim","St‑Germain","Sour","Shaken"],ingredients:["40 ml gin","25 ml St-Germain","20 ml suco de pepino","10 ml suco de limão","1 pitada de sal"],steps:["Bata tudo com gelo.","Coe duplo em coupe."],notes:"Floral + pepino = algo etéreo. Quase gelado mesmo sem gelo extra.",rating:0,servings:"1",custom:false},
  ...
  {name:"Strega Martini",categories:["Gim","Licor Strega","Vermute seco","Stirred"],ingredients:["50 ml gim","10 ml Strega","10 ml vermouth seco"],steps:["Mexa tudo com gelo.","Sirva bem gelado em coupe."],notes:"O Strega entra como um temperinho secreto.",rating:0,servings:"",custom:false},
  ...
  {name:"Campo Alto",categories:["Licor Strega","Gim","Sour","Shaken"],ingredients:["40 ml Strega","20 ml gin","15 ml suco de pepino","10 ml suco de limão","5 ml xarope simples","1 dash bitters aromático"],steps:["Bata tudo com gelo.","Coe duplo em coupe.","Decore com pepino."],notes:"Parece um jardim depois da chuva. Funciona muito bem no calor.",rating:0,servings:"1",custom:false},
  ...
  {name:"Alpine Highball",categories:["Licor Strega","Gim","Highball","Built"],ingredients:["30 ml Strega","30 ml gin","água tônica","zest de limão + tomilho"],steps:["Coloque gelo num copo alto.","Adicione Strega e gin.","Complete com tônica.","Decore com zest e tomilho."],notes:"Meio caminho entre G&T e algo completamente novo.",rating:0,servings:"1",custom:false},
  ...
  {name:"Sherry Sour",categories:["Jerez","Sour","Shaken"],ingredients:["60 ml Jerez Amontillado","25 ml suco de limão","15 ml xarope simples","clara de ovo (opcional)"],steps:["Dry shake se usar clara.","Adicione gelo e agite.","Coe em coupe."],notes:"Mais leve que um Whisky Sour, mas elegante.",rating:0,servings:"",custom:false},
  ...
  {name:"Dark Tropic",categories:["Averna","Sour","Shaken"],ingredients:["45 ml Averna","30 ml suco de abacaxi","10 ml suco de limão tahiti","5 ml xarope de gengibre"],steps:["Combine tudo na coqueteleira com gelo.","Agite bem por 12s.","Coe em copo baixo com gelo."],notes:"Tropical, mas com sombra. Nada de drink solar demais — o Averna ancora tudo.",rating:0,servings:"1",custom:false},

  // ── ABSINTO ──
  {name:"Jardim Noturno",categories:["Absinto","St‑Germain","Highball","Built"],ingredients:["30 ml absinto","20 ml St-Germain","10 ml xarope de mel (1:1)","15 ml suco de limão siciliano","água com gás para completar"],steps:["Coloque gelo num copo alto.","Adicione absinto, St-Germain, mel e limão.","Complete com água com gás e mexa suavemente."],notes:"Floral + anis + doçura leve. Parece um jardim depois da chuva.",rating:0,servings:"1",custom:false},
  {name:"Maçã Verde Elétrica",categories:["Absinto","Highball","Built"],ingredients:["25 ml absinto","40 ml suco de maçã verde clarificado (ou integral bom)","10 ml suco de limão","5 ml xarope simples","soda para completar"],steps:["Coloque gelo num copo alto.","Adicione absinto, maçã, limão e xarope.","Complete com soda."],notes:"Lembra bala verde adulta, com fundo herbal intrigante.",rating:0,servings:"1",custom:false},
  ...
  {name:"Industry Sour",categories:["Fernet","Gim","Sour","Shaken"],ingredients:["30 ml Fernet-Branca","30 ml gim","30 ml suco de limão","20 ml xarope simples"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"Favorito de bartenders.",rating:0,servings:"",custom:false},
  ...
  {name:"Porto Negroni",categories:["Porto","Campari","Stirred"],ingredients:["30 ml Porto Tinto","30 ml Campari","30 ml gim","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em rocks com gelo.","Expresse a casca de laranja."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Porto Branco Sour",categories:["Porto","Sour","Shaken"],ingredients:["60 ml Porto Branco","25 ml suco de limão","15 ml xarope simples","1 clara de ovo"],steps:["Dry shake.","Adicione gelo e agite.","Coe em coupe."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Black Negroni",categories:["Gim","Fernet","Stirred"],ingredients:["30 ml gim","30 ml Fernet-Branca","30 ml vermute doce","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em rocks com gelo."],notes:"Intenso e herbal.",rating:0,servings:"",custom:false},
  ...
  {name:"Fernet Ginger Highball",categories:["Fernet","Highball","Buck","Built"],ingredients:["40 ml fernet","ginger ale ou ginger beer","limão espremido","gelo"],steps:["Coloque gelo em copo highball.","Adicione o fernet.","Complete com ginger beer e esprema o limão.","Mexa suavemente."],notes:"Fresco, picante e muito equilibrado. Se você curte Cynar + ginger, vai gostar disso.",rating:0,servings:"",custom:false},
  ...
  // ── CAMPARI MODERNO ──
  {name:"Jardim Suspenso",categories:["Campari","Gim","Collins","Built"],ingredients:["40 ml Campari","20 ml gin","15 ml cordial de pepino (ou suco fresco)","10 ml suco de limão siciliano","soda para completar","folha de manjericão"],steps:["Esmague levemente o manjericão no copo.","Adicione gelo, Campari, gin, pepino e limão.","Complete com soda."],notes:"O Campari vira folha amarga em vez de casca cítrica. Verde e elegante.",rating:0,servings:"1",custom:false},
  ...
  {name:"Rubor Picante",categories:["Campari","Tequila","Sour","Shaken"],ingredients:["40 ml Campari","20 ml tequila branca","15 ml suco de limão","10 ml xarope simples","1 rodela fina de pimenta dedo-de-moça"],steps:["Bata todos os ingredientes com gelo.","Coe fino em coupe."],notes:"Picante puxa o amargo para frente — um bitter spicy margarita que nunca existiu.",rating:0,servings:"1",custom:false},
  ...
  {name:"Casca & Fumaça",categories:["Campari","Mezcal","Stirred"],ingredients:["40 ml Campari","20 ml mezcal","10 ml licor de laranja seco","1 dash Angostura","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em rocks.","Flambear a casca de laranja por cima."],notes:"Amargo + defumado + cítrico seco = super gastronômico.",rating:0,servings:"1",custom:false},
  {name:"Bitter & Melão",categories:["Campari","Vodka","Sour","Shaken"],ingredients:["35 ml Campari","25 ml vodka","20 ml suco de melão","10 ml xarope de mel"],steps:["Bata tudo com gelo.","Coe em coupe ou rocks gelado."],notes:"O melão suaviza sem apagar o amargor. Perigosamente fácil de beber.",rating:0,servings:"1",custom:false},
  ...
  // ── CORDIAL COCKTAILS ──
  {name:"Solar Fizz",categories:["Vodka","Highball","Built","Cordial"],ingredients:["50 ml vodka","35 ml cordial cítrico clarificado","soda para completar","gelo"],steps:["Coloque gelo num copo alto.","Adicione vodka e cordial.","Complete com soda bem gelada."],notes:"Parece água com gás... até não ser. A clarificação deixa o cordial cristalino e a acidez polida.",rating:0,servings:"1",custom:false},
  {name:"Jardim Alto",categories:["Gim","Collins","Built","Cordial"],ingredients:["50 ml gin","30 ml cordial verde (hortelã + manjericão)","10 ml suco de limão","água com gás para completar"],steps:["Coloque gelo num copo alto.","Adicione gin, cordial e limão.","Complete com água com gás e mexa suavemente."],notes:"Cheiro de horta depois da chuva. O cordial verde faz todo o trabalho aromático.",rating:0,servings:"1",custom:false},
  {name:"Trópico Seco",categories:["Rum Envelhecido","Stirred","Cordial"],ingredients:["50 ml rum ouro","35 ml cordial de abacaxi especiado","2 dashes Angostura","gelo grande"],steps:["Combine rum, cordial e bitters no copo com gelo grande.","Mexa suavemente por 20s.","Sirva no mesmo copo."],notes:"Lembra tiki... mas de camisa social. As especiarias do cordial ancoram o abacaxi.",rating:0,servings:"1",custom:false},
  {name:"Rubi Tônico",categories:["Gim","Highball","Built","Cordial"],ingredients:["45 ml gin","30 ml cordial de frutas vermelhas","água tônica para completar"],steps:["Coloque gelo num copo alto.","Adicione gin e cordial.","Complete com tônica e mexa suavemente."],notes:"Tipo um vinho que virou highball. O cordial dá cor e acidez sem perder elegância.",rating:0,servings:"1",custom:false},
  {name:"Linha Clara",categories:["Tequila","Stirred","Cordial"],ingredients:["50 ml tequila","30 ml cordial clarificado","5 ml solução salina (0,9%)","gelo grande"],steps:["Combine tequila, cordial e sal num copo baixo com gelo grande.","Mexa suavemente.","Sirva sem filtrar."],notes:"Parece água. Engana fácil. A clarificação apaga a cor mas não o sabor.",rating:0,servings:"1",custom:false},
  {name:"Flor de Pressa",categories:["Vodka","Espumante","Spritz","Built","Cordial"],ingredients:["40 ml vodka","25 ml cordial floral (sabugueiro ou base floral)","espumante para completar"],steps:["Coloque gelo numa taça de vinho.","Adicione vodka e cordial.","Complete com espumante gelado e sirva."],notes:"Perigoso de descer rápido. Floral + bolhas = bebível demais.",rating:0,servings:"1",custom:false},
  {name:"Dourado Frio",categories:["Whisky","Stirred","Cordial"],ingredients:["50 ml bourbon","25 ml cordial de mel e limão","gelo grande"],steps:["Coloque o gelo num copo baixo.","Adicione bourbon e cordial.","Mexa suavemente e sirva."],notes:"Conforto líquido sem pesar. O cordial integra mel e ácido de forma que o bourbon absorve melhor.",rating:0,servings:"1",custom:false},
  {name:"Névoa Verde",categories:["Gim","Sour","Shaken","Cordial"],ingredients:["45 ml gin","30 ml Cordial de Pêra Assada","10 ml suco de limão"],steps:["Combine tudo na coqueteleira com gelo.","Bata bem.","Coe em coupe."],notes:"Aquele drink que você não entende, mas quer outro. Pera assada + ervas do gin + limão = sutileza em camadas.",rating:0,servings:"1",custom:false},
  ...
  {name:"Kingston Mineral",categories:["Rum Envelhecido","Stirred"],ingredients:["45 ml rum jamaicano","15 ml chá preto frio","5 ml xarope demerara","2 gotas solução salina"],steps:["Combine tudo no copo misturador com gelo.","Mexa por 25s.","Coe em rocks com gelo grande."],notes:"",rating:0,servings:"1",custom:false},
];
            ...
            <div style={{marginBottom:16,position:"relative"}}>
              <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
                {previewImgs.map((url,i)=>(
                  <div key={i} style={{flex:"1 1 calc(50% - 3px)",minWidth:100,borderRadius:5,overflow:"hidden",border:"1px solid rgba(240,235,225,0.07)"}}>
...
function Modal({recipe,onClose,isFav,onFav,isTried,onTried,isComanda,onComanda,onRating,onNote,onFilter,onEdit,onDelete,onRepo}){
  ...
  return(
    <div onClick={onClose} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.92)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:400,padding:20,backdropFilter:"blur(12px)"}}>
      ...
      <div ref={shareCardRef} style={{position:"fixed",left:-9999,top:-9999,width:400,background:`linear-gradient(145deg,${theme.bg} 0%,#080808 100%)`,border:`1px solid ${theme.border}55`,borderRadius:12,padding:"28px 30px",fontFamily:"Archivo,sans-serif",overflow:"hidden"}}>
        {(recipe.custom||recipe.adjusted)&&<div style={{position:"absolute",top:24,right:-70,width:260,transform:"rotate(45deg)",background:`linear-gradient(to right, transparent, ${theme.accent}40)`,textAlign:"center",fontSize:9,letterSpacing:2,textTransform:"uppercase",color:theme.accent,fontFamily:"Archivo,sans-serif",fontWeight:700,padding:"1px 0",pointerEvents:"none",zIndex:5}}>{recipe.custom?"AUTORAL":"AJUSTADA"}</div>}
        ...
        {steps.length>0&&(
          <>
            <div style={{fontSize:9,letterSpacing:2.5,textTransform:"uppercase",color:theme.accent,opacity:.6,marginBottom:10}}>Modo de preparo</div>
            <div style={{display:"flex",flexDirection:"column",gap:8,marginBottom:20}}>
              {steps.map((s,i)=>(
                <div key={i} style={{display:"grid",gridTemplateColumns:"18px 1fr",gap:8,alignItems:"start"}}>
                  <div style={{width:18,height:18,borderRadius:2,border:`1px solid ${theme.border}`,color:theme.label,fontSize:9,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>{i+1}</div>
                  <div style={{fontSize:11,color:"rgba(240,235,225,0.62)",lineHeight:1.6}}>{s}</div>
                </div>
              ))}
            </div>
          </>
        )}
        {noteVal&&<div style={{borderLeft:`2px solid ${theme.accent}44`,paddingLeft:12,marginTop:4,marginBottom:16}}>
...
// ─── MOBILE NAV ───────────────────────────────────────────────────────────────
function MobileNav({ tab, setTab, favCount, onSameTab }) {
  const items = [
  ...
  return (
    <div style={{padding:"20px 20px 20px"}}>
      ...
      {user ? (
        ...
        <>
          <button onClick={handleSignIn} disabled={authLoading} style={{width:"100%",marginBottom:authError?8:28,padding:"14px 16px",borderRadius:5,background:"rgba(240,235,225,0.04)",border:"1px solid rgba(240,235,225,0.1)",color:"#F0EBE1",fontSize:14,cursor:authLoading?"not-allowed":"pointer",fontFamily:"Archivo,sans-serif",display:"flex",alignItems:"center",justifyContent:"center",gap:12,opacity:authLoading?0.6:1}}>
          ...
          {authError&&<div style={{marginBottom:28,padding:"10px 12px",borderRadius:4,background:"rgba(180,60,60,0.15)",border:"1px solid rgba(180,60,60,0.3)",fontSize:11,color:"#e08080",fontFamily:"Archivo,sans-serif",wordBreak:"break-all"}}>{authError}</div>}
        </>
      )}
      ...
      <div style={{display:"flex",flexDirection:"column",gap:8}}>
        ...
        {restoreConfirm==="recipes"?(
          <div style={{padding:"14px",borderRadius:3,background:"rgba(239,68,68,0.04)",border:"1px solid rgba(239,68,68,0.18)"}}>
            <p style={{margin:"0 0 10px",fontSize:12,color:"rgba(240,235,225,0.6)",lineHeight:1.6}}>As receitas originais voltam ao padrão. Suas receitas criadas e avaliações são mantidas.</p>
            <div style={{display:"flex",gap:8}}>
              <button onClick={()=>{onRestoreRecipes();setRestoreConfirm(null);}} style={{padding:"7px 14px",borderRadius:3,background:"rgba(239,68,68,0.15)",border:"1px solid rgba(239,68,68,0.4)",color:"#F87171",fontSize:11,cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>confirmar</button>
              <button onClick={()=>setRestoreConfirm(null)} style={{padding:"7px 12px",borderRadius:3,background:"none",border:"1px solid rgba(240,235,225,0.1)",color:"rgba(240,235,225,0.52)",fontSize:11,cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>cancelar</button>
            </div>
          </div>
        ):(
          <button onClick={()=>setRestoreConfirm("recipes")} style={{...btnSt,color:"rgba(239,68,68,0.7)",borderColor:"rgba(239,68,68,0.15)"}}><span style={{fontSize:16}}>↺</span> Restaurar receitas originais</button>
        )}

        {restoreConfirm==="all"?(
          <div style={{padding:"14px",borderRadius:3,background:"rgba(239,68,68,0.04)",border:"1px solid rgba(239,68,68,0.18)"}}>
            <p style={{margin:"0 0 10px",fontSize:12,color:"rgba(240,235,225,0.6)",lineHeight:1.6}}>Esta ação vai redefinir toda a experiência — receitas originais voltam ao padrão e as suas receitas criadas serão apagadas. Não dá pra desfazer.</p>
            <div style={{display:"flex",gap:8}}>
              <button onClick={()=>{onRestoreAll();setRestoreConfirm(null);}} style={{padding:"7px 14px",borderRadius:3,background:"rgba(239,68,68,0.15)",border:"1px solid rgba(239,68,68,0.4)",color:"#F87171",fontSize:11,cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>confirmar</button>
              <button onClick={()=>setRestoreConfirm(null)} style={{padding:"7px 12px",borderRadius:3,background:"none",border:"1px solid rgba(240,235,225,0.1)",color:"rgba(240,235,225,0.52)",fontSize:11,cursor:"pointer",fontFamily:"Archivo,sans-serif"}}>cancelar</button>
            </div>
          </div>
        ):(
          <button onClick={()=>setRestoreConfirm("all")} style={{...btnSt,color:"rgba(239,68,68,0.7)",borderColor:"rgba(239,68,68,0.15)"}}><span style={{fontSize:16}}>⊗</span> Restaurar app original</button>
        )}
      </div>
      ...
      <div style={{marginTop:28,marginBottom:8}}>
        ...
        <div style={{background:"rgba(240,235,225,0.02)",border:"1px solid rgba(240,235,225,0.06)",borderRadius:5,padding:"16px 16px",display:"flex",flexDirection:"column",gap:10}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"baseline"}}>
            ...
            <span onClick={handleVersionTap} style={{fontSize:10,color:"rgba(240,235,225,0.42)",letterSpacing:1,cursor:"default",userSelect:"none"}}>v1.0</span>
          </div>
            ...
            <>
              ...
              {filterSheet==="ocasiao"&&(
                <div className="mnv" style={{display:"none",flexDirection:"column",background:"rgba(22,14,6,0.98)",border:"1px solid rgba(160,120,90,0.28)",borderRadius:10,padding:"12px 14px 10px",marginBottom:12,gap:8}}>
                  ...
                  {activeOccasions.length>0&&<button onClick={()=>setActiveOccasions([])} style={{marginTop:4,fontSize:9,color:"rgba(240,235,225,0.3)",background:"none",border:"none",cursor:"pointer",letterSpacing:1,fontFamily:"Archivo,sans-serif",textAlign:"left"}}>limpar ocasião ×</button>}
                </div>
              )}
              {/* family description */}
