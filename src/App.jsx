...
const BASE_RECIPES = [
  ...
  {name:"Granada Ginger Margarita",categories:["Cointreau","Tequila","Sour","Shaken"],ingredients:["60ml tequila","15ml suco de romã","30ml suco de limão","15ml cointreau","15ml cerveja de gengibre"],steps:["Bata tudo com gelo e sirva."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Jasmine (Casa do Porco)",categories:["Campari","Cointreau","Gim","Sour","Shaken"],ingredients:["45 ml Gim","15 ml Campari","15 ml Contreau","20 ml suco de limão"],steps:["Agite todos os ingredientes com gelo por 15s.","Coe em taça de coquetel gelada.","Decore com casca de limão."],notes:"Cítrico, amargo e seco. Um sour sofisticado com alma italiana.",rating:0,servings:"1",custom:false},
  ...
  {name:"Lavender Gim Sour",categories:["Gim","Sour","Shaken"],ingredients:["50 ml Gim","20ml xarope de lavanda","25ml suco de limão","7,5ml creme de leite fresco","7,5ml xarope de violeta","1 clara de ovo"],steps:["Dry shake por 15s.","Adicione gelo e agite por mais 15s.","Coe em taça coupe."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Manhattan com cereja de verdade",categories:["Luxardo Maraschino","Vermute Tinto","Whisky","Stirred"],ingredients:["50 ml whisky (centeio fica lindo)","25 ml vermouth rosso","5 ml Luxardo Maraschino","2 dashes Angostura"],steps:["Mexa tudo com gelo em copo misturador.","Coe em taça gelada.","Decore com cereja Luxardo."],notes:"O Luxardo não grita — ele sussurra e melhora tudo.",rating:0,servings:"1",custom:false},
  ...
  {name:"Improved Whiskey Cocktail",categories:["Whisky","Luxardo Maraschino","Stirred","Cocktail"],ingredients:["50 ml whisky (bourbon ou centeio)","5 ml Luxardo Maraschino","5 ml xarope simples","2 dashes Angostura","twist de limão"],steps:["Misture whisky, Luxardo, xarope e Angostura com gelo.","Mexa bem e coe em rocks com gelo.","Expresse o twist de limão e coloque no copo."],notes:"É tipo um Old Fashioned que decidiu usar um perfume italiano.",rating:0,servings:"1",custom:false},
  ...
  {name:"Margarita",categories:["Cointreau","Tequila","Sour","Shaken"],ingredients:["50 ml Tequila","25 ml suco de limão","25 ml Triple Sec","sal na borda (opcional)"],steps:["Agite tudo com gelo.","Coe em taça com borda de sal."],notes:"",rating:0,servings:"",custom:false},
  {name:"Martinez",categories:["Gim","Luxardo Maraschino","Vermute Tinto","Stirred"],ingredients:["45 ml gim","45 ml vermouth rosso","5 ml Luxardo Maraschino","2 dashes Angostura"],steps:["Mexa com gelo e coe."],notes:"O ancestral direto do Martini.",rating:0,servings:"",custom:false},
  ...
  {name:"Shanksjillo",categories:["Cointreau","Pisco","Whisky","Cocktail","Shaken"],ingredients:["1 dose Shanky's","1 dose Contreau","1 xícara café expresso"],steps:["Bata bem até espumar."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Tom Collins (20's B)",categories:["Gim","Collins","Vermute Branco","Built"],ingredients:["45 ml gim","15 ml vermouth branco","20 ml suco de limão","5 ml xarope simples (opcional)","2 dashes Angostura","1 fatia de pepino (opcional)","soda para completar"],steps:["Combine gim, vermouth branco, limão e xarope com gelo.","Complete com soda.","Adicione Angostura e decore com pepino."],notes:"Uma versão dos anos 20 do Collins — o vermouth branco no lugar do açúcar puro dá mais profundidade e menos doce.",rating:0,servings:"1",custom:false},
  ...
  {name:"Last Word",categories:["Gim","Luxardo Maraschino","Sour","Shaken"],ingredients:["22 ml gim","22 ml Green Chartreuse","22 ml Luxardo Maraschino","22 ml suco de limão"],steps:["Combine em partes iguais com gelo.","Agite e coe em taça coupe."],notes:"Partes iguais. Um dos drinks mais equilibrados da história.",rating:0,servings:"1",custom:false},
  ...
  {name:"Frozen Margarita",categories:["Tequila","Cointreau","Sour","Shaken"],ingredients:["60 ml tequila","30 ml Cointreau","30 ml suco de limão","1 xícara gelo picado","sal na borda"],steps:["Prepare a borda com sal.","Bata tudo no liquidificador até ficar cremoso.","Sirva na taça preparada."],notes:"",rating:0,servings:"1",custom:false},
  ...
  {name:"Corpse Reviver #2",categories:["Gim","Lillet","Sour","Shaken"],ingredients:["22 ml gim","22 ml Cointreau","22 ml Lillet Blanc","22 ml suco de limão","1 dash absinthe"],steps:["Enxague a taça com absinthe e descarte.","Bata o restante com gelo.","Coe na taça."],notes:"Para ressuscitar na manhã seguinte.",rating:0,servings:"",custom:false},
  {name:"White Lady",categories:["Gim","Sour","Shaken"],ingredients:["45 ml gim","25 ml Cointreau","20 ml suco de limão","1 clara de ovo (opcional)"],steps:["Dry shake se usar clara.","Adicione gelo e agite.","Coe em coupe."],notes:"",rating:0,servings:"",custom:false},
  ...
  // ── WHISKEY ──
  {name:"Black Manhattan",categories:["Whisky","Cocktail","Stirred"],ingredients:["60 ml whisky de centeio","30 ml Averna Amaro","1 dash Angostura","1 dash Orange Bitters","cereja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Decore com cereja."],notes:"Averna no lugar do vermute.",rating:0,servings:"",custom:false},
  {name:"Toronto",categories:["Whisky","Fernet-Branca","Cocktail","Stirred"],ingredients:["60 ml whisky de centeio","15 ml Fernet-Branca","5 ml xarope simples","1 dash Angostura","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Expresse a casca."],notes:"",rating:0,servings:"",custom:false},
  ...
  // ── LUXARDO ──
  {name:"Tuxedo",categories:["Gim","Luxardo Maraschino","Stirred"],ingredients:["45 ml gim","45 ml vermute seco","7 ml Maraschino","1 dash absinthe","casca de limão"],steps:["Mexa tudo com gelo.","Coe em coupe."],notes:"Dry Martini com camadas.",rating:0,servings:"",custom:false},
  ...
  {name:"Porto Negroni",categories:["Porto Tinto","Campari","Cocktail","Stirred"],ingredients:["30 ml Porto Tinto","30 ml Campari","30 ml gim","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em rocks com gelo.","Expresse a casca de laranja."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"White Negroni Tropical",categories:["Gim","Lillet","Cynar","Luxardo Maraschino","Stirred","Cocktail"],ingredients:["30 ml gim","30 ml Lillet Blanc","20 ml Cynar","5 ml Luxardo"],steps:["Mexa todos os ingredientes com gelo.","Coe em rocks com gelo.","Decore com casca de laranja."],notes:"Perfil: amargo elegante + leve dulçor + herbal profundo. O Cynar puxa pro vegetal, o Luxardo dá aquele eco doce no fundo.",rating:0,servings:"1",custom:false},
  ...
  {name:"Jasmine",categories:["Gim","Campari","Lillet","Sour","Shaken"],ingredients:["30 ml gim","15 ml Campari","15 ml Cointreau","15 ml suco de limão"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"Equilibrado — amargo, doce e cítrico ao mesmo tempo.",rating:0,servings:"",custom:false},
  ...
  {name:"Angel Face",categories:["Gim","Cocktail","Shaken"],ingredients:["30 ml gim","30 ml apricot brandy (licor de damasco)","30 ml calvados ou brandy de maçã"],steps:["Combine tudo na coqueteleira com gelo.","Agite e coe em taça coupe."],notes:"IBA official. Partes iguais — o calvados e o damasco elevam o gim de forma inesperada.",rating:0,servings:"1",custom:false},
  ...
  {name:"Margarita Laranja Sanguínea e Coco",categories:["Cointreau","Tequila","Sour","Shaken"],ingredients:["60 ml tequila","15 ml licor de laranja","30 ml suco de limão taiti","30 ml suco de laranja sanguínea","15 ml creme de coco"],steps:["Combine tudo na coqueteleira com gelo.","Agite por 15s.","Coe em rocks com gelo."],notes:"Cor rosada natural, sabor equilibrado. A laranja sanguínea traz complexidade e o coco suaviza a acidez.",rating:0,servings:"1",custom:false},
  {name:"Margarita de Kiwi Vermelho",categories:["Cointreau","Tequila","Sour","Shaken"],ingredients:["60 ml tequila","15 ml licor de laranja","30 ml suco de limão taiti","½ kiwi vermelho amassado","15 ml xarope de agave"],steps:["Macere o kiwi vermelho no fundo da coqueteleira.","Adicione tequila, licor de laranja, limão e agave com gelo.","Agite por 15s e coe duplo em rocks com gelo."],notes:"Kiwi vermelho (tropical) tem sabor mais suave e floral que o verde. Cor rosada natural sem corante.",rating:0,servings:"1",custom:false},
  {name:"Key Lime Pie Margarita",categories:["Cointreau","Tequila","Sour","Shaken"],ingredients:["60 ml tequila","15 ml licor de laranja","30 ml suco de limão taiti","15 ml xarope de baunilha","2 barspoons iogurte de limão","biscoito graham cracker triturado para a borda"],steps:["Prepare a borda com biscoito triturado.","Combine tudo na coqueteleira com gelo.","Agite por 15s.","Coe em rocks com gelo."],notes:"Releitura da torta em drinque. O iogurte traz cremosidade e acidez láctica — a baunilha amarra o conjunto.",rating:0,servings:"1",custom:false},
  {name:"Margarita Ancho Chili e Toranja",categories:["Cointreau","Tequila","Sour","Shaken"],ingredients:["45 ml tequila","15 ml licor de laranja","30 ml suco de limão taiti","30 ml suco de grapefruit","15 ml xarope de pimenta ancho","borda de ancho chili, sal e raspas de limão"],steps:["Prepare a borda com ancho chili, sal e raspas de limão.","Combine tudo na coqueteleira com gelo.","Agite por 15s.","Coe em rocks com gelo."],notes:"Xarope de ancho chili: ferva 1 xícara de água + 1 xícara de açúcar + 2 col. sopa de pimenta ancho moída. Coe e esfrie. Defumado, cítrico e com calor progressivo.",rating:0,servings:"1",custom:false},
      ...
      <div>
        ...
        <div style={{fontSize:10,color:"rgba(240,235,225,0.52)",lineHeight:1.65}}>
          {recipe.ingredients.slice(0,3).map((ing,i)=>(
            <span key={i} style={{display:"inline-block",whiteSpace:"nowrap"}}>{i>0&&<span style={{opacity:.4,margin:"0 4px"}}>·</span>}{ing}</span>
