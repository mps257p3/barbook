...
const BASE_RECIPES = [
  ...
  {name:"Gim Fizz",categories:["Gim","Fizz","Shaken"],ingredients:["60 ml Gim","30 ml suco de lima","22 ml xarope simples","Água com gás","1 fatia limão"],steps:["Agite gim, limão e xarope com gelo.","Coe em copo alto.","Complete com água com gás.","Receita de Xarope Simples disponível em Preparos Caseiros."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Lavender Gim Sour",categories:["Gim","Sour","Shaken"],ingredients:["50 ml Gim","20 ml xarope de lavanda","25 ml suco de limão","7,5 ml creme de leite fresco","7,5 ml xarope de violeta","1 clara de ovo"],steps:["Dry shake por 15s.","Adicione gelo e agite por mais 15s.","Coe em taça coupe.","Receita de Xarope de Lavanda disponível em Preparos Caseiros."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Bee's Knees",categories:["Gim","Sour","Shaken"],ingredients:["60 ml gim","25 ml suco de limão","22 ml xarope de mel"],steps:["Combine tudo com gelo e agite bem.","Coe em taça coupe gelada.","Decore com casca de limão.","Receita de Xarope de Mel disponível em Preparos Caseiros."],notes:"O xarope de mel: dissolva mel em água quente na proporção 1:1.",rating:0,servings:"1",custom:false},
  ...
  {name:"Jardim de Caju",categories:["Gim","Sour","Shaken"],ingredients:["50 ml gin","30 ml suco fresco de caju","15 ml limão siciliano","10 ml xarope simples","1 folha pequena de manjericão"],steps:["Macere levemente o manjericão no shaker.","Adicione os demais ingredientes e gelo.","Shake e coe duplo em coupe.","Receita de Xarope Simples disponível em Preparos Caseiros."],notes:"Herbal, fresco e muito gastronômico. O manjericão amplia a complexidade verde do gin.",rating:0,servings:"1",custom:false},
  ...
  // ── MARACUJÁ ──
  {name:"Maracujá Tônico",categories:["Gim","Highball"],ingredients:["50 ml gin","15 ml polpa de maracujá","15 ml limão siciliano","10 ml xarope simples","água tônica"],steps:["Combine gin, maracujá, limão e xarope no shaker com gelo.","Shake e coe em copo highball com gelo.","Complete com água tônica.","Receita de Xarope Simples disponível em Preparos Caseiros."],notes:"Cítrico, seco e aromático. Refrescante sem parecer sobremesa.",rating:0,servings:"1",custom:false},
  ...
  {name:"Saturn",categories:["Gim","Tiki","Shaken"],ingredients:["45 ml gin","15 ml polpa de maracujá","15 ml limão siciliano","15 ml Xarope de amêndoa (Orgeat)","7 ml falernum"],steps:["Combine todos os ingredientes no shaker com gelo.","Shake e coe em copo Tiki ou highball com gelo britado.","Receitas de Xarope de amêndoa (Orgeat) e Falernum Caseiro disponíveis em Preparos Caseiros."],notes:"Clássico cult de tiki. Herbal, tropical e complexo — um dos drinks de maracujá mais sofisticados já feitos.",rating:0,servings:"1",custom:false},
  ...
  // ── GIN ──
  {name:"Tom Collins",categories:["Gim","Collins","Built"],ingredients:["60 ml gim","30 ml suco de limão","15 ml xarope simples","soda para completar","rodela de limão e cereja"],steps:["Combine gim, limão e xarope em copo Collins com gelo.","Complete com soda.","Decore.","Receita de Xarope Simples disponível em Preparos Caseiros."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Southside",categories:["Gim","Sour","Shaken"],ingredients:["60 ml gim","25 ml suco de limão","20 ml xarope simples","6 folhas de hortelã"],steps:["Macere levemente a hortelã.","Bata tudo com gelo.","Coe duplo em coupe.","Receita de Xarope Simples disponível em Preparos Caseiros."],notes:"Gim Mojito elegante.",rating:0,servings:"",custom:false},
  ...
  {name:"Industry Sour",categories:["Fernet","Gim","Sour","Shaken"],ingredients:["30 ml Fernet-Branca","30 ml gim","30 ml suco de limão","20 ml xarope simples"],steps:["Bata tudo com gelo.","Coe em coupe.","Receita de Xarope Simples disponível em Preparos Caseiros."],notes:"Favorito de bartenders.",rating:0,servings:"",custom:false},
  ...
  {name:"Bitter & Melão",categories:["Campari","Vodka","Sour","Shaken"],ingredients:["35 ml Campari","25 ml vodka","20 ml suco de melão","10 ml xarope de mel"],steps:["Bata tudo com gelo.","Coe em coupe ou rocks gelado.","Receita de Xarope de Mel disponível em Preparos Caseiros."],notes:"O melão suaviza sem apagar o amargor. Perigosamente fácil de beber.",rating:0,servings:"1",custom:false},
