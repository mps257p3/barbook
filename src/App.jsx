...
const BASE_RECIPES = [
  ...
  {name:"White Russian de abóbora",categories:["Vodka","Built"],ingredients:["60 ml vodka","60 ml Kahlúa","30 ml creme de leite batido com geleia de abóbora"],steps:["Coloque gelo num copo rocks.","Despeje a vodka e o Kahlúa sobre o gelo.","Bata levemente o creme com a geleia de abóbora e despeje por cima, deixando flutuante."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"White Russian",categories:["Vodka","Built"],ingredients:["50 ml vodka","25 ml Kahlúa","25 ml creme de leite fresco"],steps:["Coloque gelo em rocks.","Adicione vodka e Kahlúa.","Despeje o creme por cima devagar — sem mexer para criar camada."],notes:"Sem creme vira Black Russian.",rating:0,servings:"1",custom:false},
  ...
  {name:"Stinger",categories:["Conhaque","Stirred"],ingredients:["60 ml conhaque","20 ml creme de menta branco"],steps:["Mexa com gelo.","Coe em coupe ou sirva em rocks com gelo britado."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Grasshopper",categories:["Shaken"],ingredients:["20 ml crème de menthe verde","20 ml crème de cacao branco","20 ml creme de leite fresco"],steps:["Combine tudo na coqueteleira com gelo.","Agite bem e coe em taça coupe."],notes:"Clássico americano pós-Proibição. Verde, cremoso e mentolado — sobremesa líquida.",rating:0,servings:"1",custom:false},
  {name:"Golden Dream",categories:["Triple Sec","Shaken"],ingredients:["20 ml Galliano","20 ml Cointreau","20 ml suco de laranja fresco","20 ml creme de leite fresco"],steps:["Combine tudo na coqueteleira com gelo.","Agite bem e coe em taça coupe."],notes:"IBA official after-dinner. Partes iguais — Galliano herbal + creme + laranja + Cointreau.",rating:0,servings:"1",custom:false},
