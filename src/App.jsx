...
const BASE_RECIPES = [
  ...
  {name:"Manhattan com cereja de verdade",categories:["Luxardo Maraschino","Vermute Rosso","Whisky","Stirred"],ingredients:["50 ml whisky (centeio fica lindo)","25 ml Vermute rosso","5 ml Luxardo Maraschino","2 dashes Angostura"],steps:["Mexa tudo com gelo em copo misturador.","Coe em taça gelada.","Decore com cereja Luxardo."],notes:"O Luxardo não grita — ele sussurra e melhora tudo.",rating:0,servings:"1",custom:false},
  ...
  {name:"Macunaíma",categories:["Cachaça","Fernet-Branca","Sour","Shaken"],ingredients:["50 ml cachaça","20 ml suco de limão","10 ml xarope simples","5 ml Fernet-Branca"],steps:["Combine tudo na coqueteleira com gelo.","Agite por 12s.","Coe em taça coupe."],notes:"O Fernet-Branca é o detalhe — amargura e complexidade sem dominar.",rating:0,servings:"",custom:false},
  ...
  {name:"Cachaça & Amaro",categories:["Cachaça Envelhecida","Stirred"],ingredients:["50 ml cachaça envelhecida","25 ml amaro (tipo Averna)","1 dash Angostura"],steps:["Combine tudo no copo misturador com gelo.","Mexa por 30s.","Coe em coupe."],notes:"Denso e noturno. A cachaça envelhecida aguenta o amaro sem perder identidade.",rating:0,servings:"",custom:false},
