...
// ─── RECEITAS ─────────────────────────────────────────────────────────────────
const BASE_RECIPES = [
  {name:"Aperol Spritz",categories:["Espumante","Highball","Built"],ingredients:["150ml prosecco","100ml Aperol","50ml água com gás","5 cubos gelo","1 rodela laranja"],steps:["Coloque os ingredientes em um copo largo","Obedeça à proporção 3:2:1 — prosecco, Aperol e água com gás"],notes:"",rating:0,servings:"",custom:false},
  {name:"Aviation",categories:["Gim","Luxardo Maraschino","Sour","Shaken"],ingredients:["45 ml gin","15 ml Luxardo Maraschino","15 ml suco de limão","(opcional) 5 ml creme de violeta"],steps:["Combine tudo na coqueteleira com gelo.","Agite e coe duplo em coupe gelada.","Decore com cereja marrasquino."],notes:"Floral e levemente ácido. O creme de violeta é opcional mas dá a cor roxa característica.",rating:0,servings:"",custom:false},
  ...
  {name:"Belle Époque (Casa do Porco)",categories:["Gim","Shaken"],ingredients:["Gin com infusão de flor de hibisco","Calda de gengibre","Limão Siciliano","Cidre Charlotte Corday"],steps:["Infuse o gin com flor de hibisco por 2h.","Combine gin, calda de gengibre e limão na coqueteleira com gelo.","Agite e coe em coupe. Complete com cidre."],notes:"Receita assinatura do Casa do Porco, SP. Floral, ácido e elegante.",rating:0,servings:"",custom:false},
  ...
  {name:"Jamaica Ginger",categories:["Rum Envelhecido","Cocktail","Shaken"],ingredients:["2 partes Rum escuro da Jamaica","1 parte groselha","3 dashes Curaçao de laranja","1 dash bitter"],steps:["Agite com gelo e coe em taça de coquetel."],notes:"",rating:0,servings:"",custom:false},
  {name:"Jasmine (Casa do Porco)",categories:["Campari","Contreau","Gim","Sour","Shaken"],ingredients:["45 ml Gin","15 ml Campari","15 ml Contreau","20 ml suco de limão"],steps:["Agite todos os ingredientes com gelo por 15s.","Coe em taça de coquetel gelada.","Decore com casca de limão."],notes:"Cítrico, amargo e seco. Um sour sofisticado com alma italiana.",rating:0,servings:"1",custom:false},
  ...
  {name:"Manhattan com cereja de verdade",categories:["Luxardo Maraschino","Vermute Tinto","Whisky","Stirred"],ingredients:["50 ml whisky (rye fica lindo)","25 ml vermouth rosso","5 ml Luxardo Maraschino","2 dashes Angostura"],steps:["Mexa tudo com gelo em copo misturador.","Coe em taça gelada.","Decore com cereja Luxardo."],notes:"O Luxardo não grita — ele sussurra e melhora tudo.",rating:0,servings:"1",custom:false},
  ...
  {name:"Improved Whiskey Cocktail",categories:["Whisky","Luxardo Maraschino","Stirred","Cocktail"],ingredients:["50 ml whisky (bourbon ou rye)","5 ml Luxardo Maraschino","5 ml xarope simples","2 dashes Angostura","twist de limão"],steps:["Misture whisky, Luxardo, xarope e Angostura com gelo.","Mexa bem e coe em rocks com gelo.","Expresse o twist de limão e coloque no copo."],notes:"É tipo um Old Fashioned que decidiu usar um perfume italiano.",rating:0,servings:"1",custom:false},
  ...
  {name:"Margarita",categories:["Contreau","Tequila","Sour","Shaken"],ingredients:["50 ml Tequila","25 ml suco de limão","25 ml Triple Sec","sal na borda (opcional)"],steps:["Agite tudo com gelo.","Coe em taça com borda de sal."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Mojito",categories:["Rum","Smash","Built"],ingredients:["40ml rum","30ml suco de limão","2 col. sobremesa açúcar","10 folhas hortelã","água com gás","Gelo"],steps:["Macere hortelã, açúcar e limão no copo.","Adicione gelo e rum.","Complete com água gaseificada."],notes:"",rating:0,servings:"",custom:false},
  {name:"Mojito Amendoado",categories:["Rum","Smash","Built"],ingredients:["50ml rum branco","10 folhas hortelã","20ml limão taiti","20ml xarope de amêndoa","Tônica de gengibre Britvic"],steps:["Bata tudo exceto a tônica.","Adicione a tônica ao final."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Mr. Grinch",categories:["Tequila","Sour","Shaken"],ingredients:["60ml tequila ou mezcal","30ml suco de pepino","15ml xarope de jalapeño","10ml suco de limão"],steps:["Bata tudo com gelo. Sirva com hortelã."],notes:"",rating:0,servings:"",custom:false},
  {name:"Negroni",categories:["Campari","Gim","Vermute Tinto","Stirred"],ingredients:["30 ml Gin","30 ml Campari","30 ml Vermute tinto"],steps:["Adicione gelo no copo.","Adicione os três ingredientes em partes iguais.","Mexa e decore com casca de laranja."],notes:"",rating:0,servings:"1",custom:false},
  {name:"Negroni Sbagliato",categories:["Campari","Espumante","Spritz","Vermute Tinto","Built"],ingredients:["30 ml Campari","30 ml vermouth rosso","prosecco para completar"],steps:["Encha copo rocks com gelo.","Adicione Campari e vermouth rosso.","Complete com prosecco pela lateral. Mexa levemente.","Decore com casca de laranja."],notes:"Amargo, herbáceo e mais leve que o Negroni tradicional. As borbulhas suavizam o amargor.",rating:0,servings:"",custom:false},
  ...
  {name:"Pisco Sour",categories:["Pisco","Sour","Shaken"],ingredients:["45mL pisco","30mL suco limão Taiti","20mL xarope de açúcar","1 clara","Gelo","Bitter Angostura"],steps:["Agite tudo por 30-45s.","Coe e pingue 1-2 gotas de bitter."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Sevilla Sour",categories:["Gim","St‑Germain","Sour","Shaken"],ingredients:["50 ml Flor de Sevilla","20 ml St-Germain","25 ml limão siciliano","10 ml xarope simples","clara de ovo (opcional)"],steps:["Dry shake todos os ingredientes por 10s sem gelo.","Adicione gelo e agite por mais 15s.","Coe em taça coupe."],notes:"Cítrico, floral e levemente amargo. O gin Flor de Sevilla traz laranja e complexidade naturais.",rating:0,servings:"",custom:false},
  {name:"Shanksjillo",categories:["Contreau","Pisco","Whisky","Cocktail","Shaken"],ingredients:["1 dose Shanky's","1 dose Contreau","1 xícara café expresso"],steps:["Bata bem até espumar."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Tom Collins (20's B)",categories:["Gim","Collins","Vermute Branco","Built"],ingredients:["45 ml gin","15 ml vermouth branco","20 ml suco de limão","5 ml xarope simples (opcional)","2 dashes Angostura","1 fatia de pepino (opcional)","soda para completar"],steps:["Combine gin, vermouth branco, limão e xarope com gelo.","Complete com soda.","Adicione Angostura e decore com pepino."],notes:"Uma versão dos anos 20 do Collins — o vermouth branco no lugar do açúcar puro dá mais profundidade e menos doce.",rating:0,servings:"1",custom:false},
  ...
  {name:"White Russian de abóbora",categories:["Vodka","Cocktail","Built"],ingredients:["60ml vodka","60ml kahlua","30ml creme batido com geleia de abóbora"],steps:["Misture tudo."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Espresso Martini",categories:["Vodka","Cocktail","Shaken"],ingredients:["50 ml vodka","30 ml licor de café (Kahlúa)","30 ml espresso fresco","5 ml xarope simples"],steps:["Prepare o espresso e deixe esfriar brevemente.","Combine tudo na coqueteleira com gelo.","Agite vigorosamente por 15s — o shake forte cria a espuma.","Coe em taça coupe gelada. Decore com 3 grãos de café."],notes:"O espresso fresco (não frio) faz toda a diferença na espuma.",rating:0,servings:"1",custom:false},
  {name:"Sidecar",categories:["Conhaque","Contreau","Sour","Shaken"],ingredients:["50 ml conhaque","25 ml Cointreau","25 ml suco de limão siciliano","açúcar na borda (opcional)"],steps:["Prepare a borda da taça com açúcar.","Combine tudo com gelo e agite.","Coe em taça coupe."],notes:"Proporção clásica 2:1:1. Com mais limão fica mais seco.",rating:0,servings:"1",custom:false},
  {name:"Bee's Knees",categories:["Gim","Sour","Shaken"],ingredients:["60 ml gin","25 ml suco de limão","22 ml xarope de mel"],steps:["Combine tudo com gelo e agite bem.","Coe em taça coupe gelada.","Decore com casca de limão."],notes:"O xarope de mel: dissolva mel em água quente na proporção 1:1.",rating:0,servings:"1",custom:false},
  {name:"Last Word",categories:["Gim","Luxardo Maraschino","Sour","Shaken"],ingredients:["22 ml gin","22 ml Green Chartreuse","22 ml Luxardo Maraschino","22 ml suco de limão"],steps:["Combine em partes iguais com gelo.","Agite e coe em taça coupe."],notes:"Partes iguais. Um dos drinks mais equilibrados da história.",rating:0,servings:"1",custom:false},
  ...
  {name:"Kir Royale",categories:["Espumante","Spritz","Built"],ingredients:["120 ml champagne ou espumante brut","15 ml crème de cassis"],steps:["Coloque o cassis na flute.","Complete com champagne gelado."],notes:"Com vinho branco tranquilo vira Kir simples. O cassis deve ser de qualidade.",rating:0,servings:"1",custom:false},
  ...
  {name:"White Russian",categories:["Vodka","Cocktail","Built"],ingredients:["50 ml vodka","25 ml Kahlúa","25 ml creme de leite fresco"],steps:["Coloque gelo em rocks.","Adicione vodka e Kahlúa.","Despeje o creme por cima devagar — sem mexer para criar camada."],notes:"Sem creme vira Black Russian.",rating:0,servings:"1",custom:false},
  ...
  {name:"Black Russian",categories:["Vodka","Cocktail","Stirred"],ingredients:["50 ml vodka","25 ml Kahlúa"],steps:["Coloque gelo em rocks.","Adicione vodka e Kahlúa. Mexa."],notes:"Com creme de leite vira White Russian.",rating:0,servings:"",custom:false},
  {name:"Godfather",categories:["Whisky","Cocktail","Stirred"],ingredients:["45 ml Scotch whisky","25 ml Amaretto"],steps:["Coloque gelo em rocks.","Adicione e mexa suavemente."],notes:"Com vodka vira Godmother.",rating:0,servings:"",custom:false},
  ...
  {name:"Rabo de Galo",categories:["Cachaça","Cocktail","Stirred"],ingredients:["50 ml cachaça","25 ml Cynar","1 dash Angostura","casca de laranja"],steps:["Mexa todos os ingredientes com gelo.","Coe em rocks com gelo.","Expresse a casca de laranja."],notes:"O Negroni brasileiro.",rating:0,servings:"",custom:false},
  {name:"Leite de Onça",categories:["Cachaça","Cocktail","Stirred"],ingredients:["50 ml cachaça","50 ml leite de coco","30 ml leite condensado","canela em pó"],steps:["Misture tudo com gelo.","Sirva em copo e finalize com canela."],notes:"Drink típico de festas juninas.",rating:0,servings:"",custom:false},
  ...
  // ── COGNAC / BRANDY ──
  {name:"Brandy Alexander",categories:["Conhaque","Cocktail","Shaken"],ingredients:["30 ml conhaque","30 ml creme de cacau escuro","30 ml creme de leite fresco","noz-moscada"],steps:["Bata tudo com gelo.","Coe em taça coupe.","Finalize com noz-moscada ralada."],notes:"",rating:0,servings:"",custom:false},
  {name:"Between the Sheets",categories:["Conhaque","Rum","Sour","Shaken"],ingredients:["30 ml conhaque","30 ml rum branco","30 ml Cointreau","15 ml suco de limão"],steps:["Bata tudo com gelo.","Coe em taça coupe."],notes:"",rating:0,servings:"",custom:false},
  {name:"Stinger",categories:["Conhaque","Cocktail","Stirred"],ingredients:["60 ml conhaque","20 ml creme de menta branco"],steps:["Mexa com gelo.","Coe em coupe ou sirva em rocks com gelo britado."],notes:"",rating:0,servings:"",custom:false},
  {name:"French Connection",categories:["Conhaque","Cocktail","Stirred"],ingredients:["45 ml conhaque","25 ml Amaretto"],steps:["Coloque gelo em rocks.","Adicione e mexa suavemente."],notes:"",rating:0,servings:"",custom:false},

  // ── TEQUILA / MEZCAL ──
  {name:"Spicy Margarita",categories:["Tequila","Sour","Shaken"],ingredients:["60 ml tequila blanco","30 ml suco de limão","20 ml Cointreau","3 rodelas jalapeño","sal na borda"],steps:["Macere o jalapeño com a tequila.","Bata com os demais ingredientes e gelo.","Coe na borda salgada."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Naked and Famous",categories:["Mezcal","Sour","Shaken"],ingredients:["22 ml mezcal","22 ml Aperol","22 ml Yellow Chartreuse","22 ml suco de limão"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"Variação do Paper Plane com mezcal.",rating:0,servings:"",custom:false},
  ...
  // ── VODKA ──
  {name:"Vesper",categories:["Gim","Vodka","Lillet","Stirred"],ingredients:["45 ml gin","15 ml vodka","15 ml Lillet Blanc","twist de limão"],steps:["Mexa todos os ingredientes com gelo.","Coe em coupe gelado.","Finalize com twist de limão."],notes:"Seco, forte, sofisticado. Aqui o Lillet entra como um perfume.",rating:0,servings:"1",custom:false},
  ...
  {name:"Harvey Wallbanger",categories:["Vodka","Highball","Built"],ingredients:["45 ml vodka","100 ml suco de laranja","15 ml Galliano","gelo"],steps:["Combine vodka e suco em copo alto com gelo.","Float o Galliano por cima."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Lemon Drop",categories:["Vodka","Sour","Shaken"],ingredients:["60 ml vodka cítrica","30 ml suco de limão","20 ml Cointreau","15 ml xarope simples","açúcar na borda"],steps:["Bata tudo com gelo.","Coe em coupe com borda açucarada."],notes:"",rating:0,servings:"",custom:false},
  ...
  // ── RUM ──
  {name:"El Presidente",categories:["Rum","Cocktail","Stirred"],ingredients:["60 ml rum dourado","30 ml vermute branco","15 ml Cointreau","1 dash grenadine","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Expresse a casca de laranja."],notes:"Clássico cubano dos anos 1920.",rating:0,servings:"",custom:false},
  ...
  {name:"Rum Old Fashioned",categories:["Rum Envelhecido","Cocktail","Stirred"],ingredients:["60 ml rum envelhecido","5 ml xarope de açúcar mascavo","2 dash Angostura","casca de laranja"],steps:["Dissolva o xarope com os bitters.","Adicione rum e gelo. Mexa bem.","Expresse a casca de laranja."],notes:"",rating:0,servings:"",custom:false},
  {name:"Painkiller",categories:["Rum","Cocktail","Shaken"],ingredients:["60 ml rum escuro","120 ml suco de abacaxi","30 ml creme de coco","30 ml suco de laranja","noz-moscada"],steps:["Bata tudo com gelo.","Sirva em copo alto.","Rale noz-moscada por cima."],notes:"",rating:0,servings:"",custom:false},
  ...
  // ── GIN ──
  {name:"Tom Collins",categories:["Gim","Collins","Built"],ingredients:["60 ml gin","30 ml suco de limão","15 ml xarope simples","soda para completar","rodela de limão e cereja"],steps:["Combine gin, limão e xarope em copo Collins com gelo.","Complete com soda.","Decore."],notes:"",rating:0,servings:"",custom:false},
  {name:"Corpse Reviver #2",categories:["Gim","Lillet","Sour","Shaken"],ingredients:["22 ml gin","22 ml Cointreau","22 ml Lillet Blanc","22 ml suco de limão","1 dash absinthe"],steps:["Enxague a taça com absinthe e descarte.","Bata o restante com gelo.","Coe na taça."],notes:"Para ressuscitar na manhã seguinte.",rating:0,servings:"",custom:false},
  {name:"White Lady",categories:["Gim","Sour","Shaken"],ingredients:["45 ml gin","25 ml Cointreau","20 ml suco de limão","1 clara de ovo (opcional)"],steps:["Dry shake se usar clara.","Adicione gelo e agite.","Coe em coupe."],notes:"",rating:0,servings:"",custom:false},
  {name:"Hanky Panky",categories:["Gim","Fernet-Branca","Stirred"],ingredients:["45 ml gin","45 ml vermute doce","7 ml Fernet-Branca","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Expresse a casca de laranja."],notes:"Criado por Ada Coleman, Savoy Hotel, 1925.",rating:0,servings:"",custom:false},
  {name:"Southside",categories:["Gim","Sour","Shaken"],ingredients:["60 ml gin","25 ml suco de limão","20 ml xarope simples","6 folhas de hortelã"],steps:["Macere levemente a hortelã.","Bata tudo com gelo.","Coe duplo em coupe."],notes:"Gin Mojito elegante.",rating:0,servings:"",custom:false},
  {name:"20th Century",categories:["Gim","Lillet","Sour","Shaken"],ingredients:["45 ml gin","20 ml Lillet Blanc","20 ml creme de cacau branco","20 ml suco de limão"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"Equilibra floral, cítrico e chocolate branco.",rating:0,servings:"",custom:false},

  // ── WHISKEY ──
  {name:"Black Manhattan",categories:["Whisky","Cocktail","Stirred"],ingredients:["60 ml rye whiskey","30 ml Averna Amaro","1 dash Angostura","1 dash Orange Bitters","cereja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Decore com cereja."],notes:"Averna no lugar do vermute.",rating:0,servings:"",custom:false},
  {name:"Toronto",categories:["Whisky","Fernet-Branca","Cocktail","Stirred"],ingredients:["60 ml rye whiskey","15 ml Fernet-Branca","5 ml xarope simples","1 dash Angostura","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Expresse a casca."],notes:"",rating:0,servings:"",custom:false},
  {name:"Blood and Sand",categories:["Whisky","Cocktail","Shaken"],ingredients:["22 ml Scotch whisky","22 ml Cherry Heering","22 ml vermute doce","22 ml suco de laranja"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"O único cocktail clássico com whisky batido.",rating:0,servings:"",custom:false},
  ...
  // ── ST-GERMAIN ──
  {name:"Elder Fashion",categories:["Whisky","St‑Germain","Cocktail","Stirred"],ingredients:["50 ml bourbon","20 ml St-Germain","1 dash Angostura","casca de limão"],steps:["Mexa tudo com gelo.","Coe em rocks com gelo.","Expresse a casca de limão."],notes:"Old Fashioned floral.",rating:0,servings:"",custom:false},
  {name:"French Gimlet",categories:["Gim","St‑Germain","Sour","Shaken"],ingredients:["50 ml gin","20 ml St-Germain","20 ml suco de limão siciliano"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"Floral e refrescante.",rating:0,servings:"",custom:false},
  ...
  // ── LUXARDO ──
  {name:"Tuxedo",categories:["Gim","Luxardo Maraschino","Stirred"],ingredients:["45 ml gin","45 ml vermute seco","7 ml Maraschino","1 dash absinthe","casca de limão"],steps:["Mexa tudo com gelo.","Coe em coupe."],notes:"Dry Martini com camadas.",rating:0,servings:"",custom:false},
  ...
  {name:"Witch's Kiss",categories:["Licor Strega","Gim","Sour","Shaken"],ingredients:["30 ml gin","30 ml Strega","20 ml suco de limão","10 ml mel"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"",rating:0,servings:"",custom:false},

  // ── JEREZ / SHERRY ──
  {name:"Bamboo",categories:["Jerez","Vermute seco","Cocktail","Stirred"],ingredients:["45 ml Fino Sherry","45 ml vermute seco","2 dash Orange Bitters","1 dash Angostura","casca de limão"],steps:["Mexa tudo com gelo.","Coe em coupe."],notes:"Baixo teor alcoólico, complexo.",rating:0,servings:"",custom:false},
  {name:"Adonis",categories:["Jerez","Vermute seco","Cocktail","Stirred"],ingredients:["60 ml Fino Sherry","30 ml vermute doce","1 dash Orange Bitters","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em coupe.","Expresse a casca de laranja."],notes:"",rating:0,servings:"",custom:false},
  {name:"Sherry Cobbler",categories:["Jerez","Cocktail","Built"],ingredients:["90 ml Amontillado Sherry","15 ml xarope de laranja","15 ml suco de limão","gelo britado","frutas da estação"],steps:["Combine sherry, xarope e limão.","Sirva em copo com gelo britado.","Decore com frutas."],notes:"Um dos coquetéis mais antigos.",rating:0,servings:"",custom:false},
  ...
  {name:"Industry Sour",categories:["Fernet-Branca","Gim","Sour","Shaken"],ingredients:["30 ml Fernet-Branca","30 ml gin","30 ml suco de limão","20 ml xarope simples"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"Favorito de bartenders.",rating:0,servings:"",custom:false},
  ...
  {name:"Porto Flip",categories:["Porto Tinto","Cocktail","Shaken"],ingredients:["60 ml Porto Tinto","10 ml conhaque","1 ovo inteiro","noz-moscada"],steps:["Bata tudo com gelo vigorosamente.","Coe em coupe.","Finalize com noz-moscada."],notes:"Clássico vitoriano.",rating:0,servings:"",custom:false},
  {name:"Porto Negroni",categories:["Porto Tinto","Campari","Cocktail","Stirred"],ingredients:["30 ml Porto Tinto","30 ml Campari","30 ml gin","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em rocks com gelo.","Expresse a casca de laranja."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"White Negroni Tropical",categories:["Gim","Lillet","Cynar","Luxardo Maraschino","Stirred","Cocktail"],ingredients:["30 ml gin","30 ml Lillet Blanc","20 ml Cynar","5 ml Luxardo"],steps:["Mexa todos os ingredientes com gelo.","Coe em rocks com gelo.","Decore com casca de laranja."],notes:"Perfil: amargo elegante + leve dulçor + herbal profundo. O Cynar puxa pro vegetal, o Luxardo dá aquele eco doce no fundo.",rating:0,servings:"1",custom:false},
  {name:"Garden Spritz",categories:["Lillet","St‑Germain","Spritz","Built"],ingredients:["40 ml Lillet Blanc","20 ml St-Germain","água com gás","hortelã ou limão"],steps:["Copo com gelo.","Adicione Lillet e St-Germain.","Complete com água com gás.","Decore com hortelã ou limão."],notes:"Perfil: floral, leve, perigoso de fácil. Isso aqui some no copo. Cuidado.",rating:0,servings:"1",custom:false},
  ...
  {name:"Almost Martini",categories:["Gim","Lillet","Vermute Branco","Stirred","Cocktail"],ingredients:["50 ml gin","25 ml Lillet Blanc","10 ml vermouth branco"],steps:["Mexa todos os ingredientes com gelo.","Coe em taça gelada."],notes:"Perfil: entre Martini e algo mais aromático. Mais acessível que um Martini clássico, menos agressivo.",rating:0,servings:"1",custom:false},
  ...
  {name:"Jasmine",categories:["Gim","Campari","Lillet","Sour","Shaken"],ingredients:["30 ml gin","15 ml Campari","15 ml Cointreau","15 ml suco de limão"],steps:["Bata tudo com gelo.","Coe em coupe."],notes:"Equilibrado — amargo, doce e cítrico ao mesmo tempo.",rating:0,servings:"",custom:false},
  ...
  {name:"Black Negroni",categories:["Gim","Fernet-Branca","Cocktail","Stirred"],ingredients:["30 ml gin","30 ml Fernet-Branca","30 ml vermute doce","casca de laranja"],steps:["Mexa tudo com gelo.","Coe em rocks com gelo."],notes:"Intenso e herbal.",rating:0,servings:"",custom:false},
  ...
  // ── VINHO / FORTIFICADO ──
  {name:"Sangria",categories:["Vinho","Built"],ingredients:["750 ml vinho tinto","100 ml brandy","50 ml Cointreau","200 ml suco de laranja","frutas cortadas","xarope a gosto"],steps:["Misture tudo e refrigere por 4h.","Sirva em copo com gelo e frutas."],notes:"",rating:0,servings:"6",custom:false},
  ...
  {name:"Rusty Nail",categories:["Whisky","Stirred"],ingredients:["45 ml Scotch whisky","25 ml Drambuie","casca de limão"],steps:["Coloque gelo em rocks.","Adicione o Scotch e o Drambuie.","Mexa suavemente.","Expresse a casca de limão e decore."],notes:"Drambuie é um licor de mel e ervas feito com base em Scotch — complementares por natureza.",rating:0,servings:"1",custom:false},
  {name:"French Martini",categories:["Vodka","Cocktail","Shaken"],ingredients:["45 ml vodka","15 ml Chambord ou licor de framboesa","30 ml suco de abacaxi fresco"],steps:["Combine tudo na coqueteleira com gelo.","Agite vigorosamente — o abacaxi cria espuma natural.","Coe em taça coupe gelada."],notes:"IBA official. A espuma de abacaxi é a assinatura visual. Agite com força.",rating:0,servings:"1",custom:false},
  {name:"Gibson",categories:["Gim","Vermute seco","Stirred"],ingredients:["75 ml gin","15 ml vermute seco","cebola pérola em conserva (garnish)"],steps:["Mexa gin e vermute com gelo por 30s.","Coe em taça coupe gelada.","Decore com cebola pérola — nunca azeitona."],notes:"É um Dry Martini, mas a cebola em conserva é o que define o Gibson.",rating:0,servings:"1",custom:false},
  {name:"Angel Face",categories:["Gim","Cocktail","Shaken"],ingredients:["30 ml gin","30 ml apricot brandy (licor de damasco)","30 ml calvados ou brandy de maçã"],steps:["Combine tudo na coqueteleira com gelo.","Agite e coe em taça coupe."],notes:"IBA official. Partes iguais — o calvados e o damasco elevam o gin de forma inesperada.",rating:0,servings:"1",custom:false},
  {name:"Monkey Gland",categories:["Gim","Sour","Shaken"],ingredients:["45 ml gin","45 ml suco de laranja fresco","1 col. chá absinto","1 col. chá grenadine"],steps:["Combine tudo na coqueteleira com gelo.","Agite e coe em taça coupe."],notes:"Criado no Harry's New York Bar, Paris, c. 1920. O absinto e a grenadine aparecem como sombras discretas.",rating:0,servings:"1",custom:false},
  ...
  {name:"Casino",categories:["Gim","Luxardo Maraschino","Sour","Shaken"],ingredients:["40 ml gin (Old Tom ou London Dry)","10 ml Luxardo Maraschino","10 ml suco de limão","2 dashes Orange Bitters"],steps:["Combine tudo na coqueteleira com gelo.","Agite bem e coe em taça coupe."],notes:"IBA classic. Com Old Tom Gin (levemente adocicado) fica mais equilibrado.",rating:0,servings:"1",custom:false},
  {name:"John Collins",categories:["Gim","Collins","Built"],ingredients:["60 ml gin London Dry","30 ml suco de limão fresco","15 ml xarope simples","60 ml soda","rodela de limão e cereja"],steps:["Combine gin, limão e xarope em copo Collins com gelo.","Complete com soda.","Mexa suavemente e decore."],notes:"Usa London Dry Gin — mais seco que o Tom Collins (Old Tom Gin).",rating:0,servings:"1",custom:false},
  {name:"Paradise",categories:["Gim","Sour","Shaken"],ingredients:["30 ml gin","20 ml apricot brandy (licor de damasco)","15 ml suco de laranja fresco"],steps:["Combine tudo na coqueteleira com gelo.","Agite e coe em taça coupe."],notes:"IBA classic. Proporção 3:2:1,5. Floral, frutado e direto.",rating:0,servings:"1",custom:false},
  ...
  {name:"Margarita Laranja Sanguínea e Coco",categories:["Contreau","Tequila","Sour","Shaken"],ingredients:["60 ml tequila","15 ml licor de laranja","30 ml suco de limão taiti","30 ml suco de laranja sanguínea","15 ml creme de coco"],steps:["Combine tudo na coqueteleira com gelo.","Agite por 15s.","Coe em rocks com gelo."],notes:"Cor rosada natural, sabor equilibrado. A laranja sanguínea traz complexidade e o coco suaviza a acidez.",rating:0,servings:"1",custom:false},
  {name:"Margarita de Kiwi Vermelho",categories:["Contreau","Tequila","Sour","Shaken"],ingredients:["60 ml tequila","15 ml licor de laranja","30 ml suco de limão taiti","½ kiwi vermelho amassado","15 ml xarope de agave"],steps:["Macere o kiwi vermelho no fundo da coqueteleira.","Adicione tequila, licor de laranja, limão e agave com gelo.","Agite por 15s e coe duplo em rocks com gelo."],notes:"Kiwi vermelho (tropical) tem sabor mais suave e floral que o verde. Cor rosada natural sem corante.",rating:0,servings:"1",custom:false},
  {name:"Key Lime Pie Margarita",categories:["Contreau","Tequila","Sour","Shaken"],ingredients:["60 ml tequila","15 ml licor de laranja","30 ml suco de limão taiti","15 ml xarope de baunilha","2 barspoons iogurte de limão","biscoito graham cracker triturado para a borda"],steps:["Prepare a borda com biscoito triturado.","Combine tudo na coqueteleira com gelo.","Agite por 15s.","Coe em rocks com gelo."],notes:"Releitura da torta em drinque. O iogurte traz cremosidade e acidez láctica — a baunilha amarra o conjunto.",rating:0,servings:"1",custom:false},
  {name:"Margarita Ancho Chili e Toranja",categories:["Contreau","Tequila","Sour","Shaken"],ingredients:["45 ml tequila","15 ml licor de laranja","30 ml suco de limão taiti","30 ml suco de grapefruit","15 ml xarope de pimenta ancho","borda de ancho chili, sal e raspas de limão"],steps:["Prepare a borda com ancho chili, sal e raspas de limão.","Combine tudo na coqueteleira com gelo.","Agite por 15s.","Coe em rocks com gelo."],notes:"Xarope de ancho chili: ferva 1 xícara de água + 1 xícara de açúcar + 2 col. sopa de pimenta ancho moída. Coe e esfrie. Defumado, cítrico e com calor progressivo.",rating:0,servings:"1",custom:false},
...
// ─── CARD ─────────────────────────────────────────────────────────────────────
function DrinkCard({recipe,isFav,onFav,isTried,onTried,isComanda,onComanda,hasAll,onClick}){
  ...
  return(
    <div onClick={onClick} onMouseEnter={()=>setHov(true)} onMouseLeave={()=>setHov(false)}
      style={{background:theme.bg,borderRadius:4,padding:"16px 16px 14px 18px",cursor:"pointer",position:"relative",overflow:"hidden",transition:"all .2s ease",transform:hov?"translateY(-2px)":"none",boxShadow:hov?`0 10px 36px rgba(0,0,0,.55), inset 0 0 40px ${theme.accent}08`:`0 2px 10px rgba(0,0,0,.45), inset 0 0 24px ${theme.accent}04`,display:"flex",flexDirection:"column",minHeight:152,borderLeft:`2px solid ${hov?theme.accent+"cc":theme.accent+"44"}`,transition:"all .2s ease"}}>
      ...
      {/* fav + comanda */}
      <button onClick={e=>{e.stopPropagation();onFav();}} style={{position:"absolute",top:8,right:8,background:"none",border:"none",fontSize:13,color:isFav?theme.accent:"rgba(255,255,255,0.1)",cursor:"pointer",padding:4,transition:"color .2s",filter:isFav?`drop-shadow(0 0 5px ${theme.accent}88)`:"none"}}>
        {isFav?"♥":"♡"}
      </button>
      ...
      <div>
        ...
        <div style={{fontSize:10,color:"rgba(240,235,225,0.52)",lineHeight:1.65}}>
        ...
        <div style={{padding:"28px 28px 32px"}}>
          ...
          <div style={{display:"flex",alignItems:"stretch",gap:0,marginBottom:24}}>
            ...
            <div style={{flex:1,minWidth:0,display:"flex",flexDirection:"column",justifyContent:"space-between"}}>
              {/* linha acento */}
              <div style={{height:1,background:`linear-gradient(90deg,${theme.accent},${theme.accent}00)`,marginBottom:16,width:"60%"}}/>
              ...
              <div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}>
                <button onClick={onTried} style={{display:"flex",alignItems:"center",gap:6,padding:"6px 12px",borderRadius:20,background:isTried?"rgba(74,222,128,0.08)":"rgba(240,235,225,0.04)",border:`1px solid ${isTried?"rgba(74,222,128,0.35)":"rgba(240,235,225,0.09)"}`,color:isTried?"#4ADE80":"rgba(240,235,225,0.32)",fontSize:11,cursor:"pointer",transition:"all .15s",fontFamily:"Archivo,sans-serif"}}>
                  <span style={{fontSize:13}}>{isTried?"✓":"○"}</span>{isTried?"Já provei":"Marcar provado"}
                </button>
                <button onClick={onFav} style={{background:"none",border:"none",fontSize:22,cursor:"pointer",color:isFav?theme.accent:"rgba(255,255,255,0.14)",filter:isFav?`drop-shadow(0 0 8px ${theme.accent})`:"none",transition:"all .2s",padding:"4px 6px"}}>{isFav?"♥":"♡"}</button>
                <button onClick={onComanda} style={{display:"flex",alignItems:"center",gap:6,padding:"6px 12px",borderRadius:20,background:isComanda?"rgba(160,120,90,0.13)":"rgba(240,235,225,0.04)",border:`1px solid ${isComanda?"rgba(160,120,90,0.5)":"rgba(240,235,225,0.09)"}`,color:isComanda?"#C8A96E":"rgba(240,235,225,0.32)",fontSize:11,cursor:"pointer",transition:"all .15s",fontFamily:"Archivo,sans-serif"}}>
                  <span style={{fontSize:13}}>{isComanda?"◫":"◻"}</span>{isComanda?"Na comanda":"+ Comanda"}
                </button>
                <button onClick={shareAsImage} disabled={sharing} title="Compartilhar" style={{background:"none",border:"1px solid rgba(240,235,225,0.1)",borderRadius:3,padding:"5px 10px",color:sharing?"rgba(240,235,225,0.2)":"rgba(240,235,225,0.4)",fontSize:13,cursor:sharing?"default":"pointer",fontFamily:"Archivo,sans-serif"}}>{sharing?"…":"↗"}</button>
              ...
              <div style={{display:"flex",flexWrap:"wrap",gap:"5px 8px"}}>
                {recipe.ingredients.slice(0,5).map((ing,i)=>(
                  <span key={i} style={{fontSize:10,color:i===0?"rgba(240,235,225,0.62)":"rgba(240,235,225,0.36)",letterSpacing:.3}}>
                    ...
                    {ing.replace(/^\d+[\d/\s]*(ml|cl|oz|dash|colher|parte|partes|pitada|fatia|rodela|folha|folhas|ramo|aros|twist)?\.?\s*/i,"")}
                  </span>
                ))}
...
function MobileNav({ tab, setTab, favCount }) {
  ...
  return (
    <nav className="mnv" style={{position:"fixed",bottom:0,left:0,right:0,background:"#080808",borderTop:"1px solid rgba(240,235,225,0.07)",zIndex:9999,paddingBottom:"env(safe-area-inset-bottom,8px)"}}>
      {items.map(t=>(
        <button key={t.id} onClick={()=>setTab(t.id)} style={{flex:1,padding:"10px 4px 8px",background:"none",border:"none",display:"flex",flexDirection:"column",alignItems:"center",gap:4,cursor:"pointer",color:tab===t.id?"#A0785A":"rgba(240,235,225,0.26)",transition:"color .15s",fontFamily:"Archivo,sans-serif"}}>
              ...
              {filterSheet==="familia"&&(
                <div className="mnv" style={{display:"none",flexDirection:"column",background:"rgba(15,13,10,0.98)",border:"1px solid rgba(240,235,225,0.08)",borderRadius:10,padding:"14px 14px 10px",marginBottom:12,gap:8}}>
                  ...
                  <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
                    {[...FAMILY_GROUPS[0].items,...TECHNIQUES].filter(s=>allRecipes.some(r=>r.categories.includes(s))).map(s=>{
                      const active=activeStyle===s;
                      const th=TYPE_THEME[s]||TYPE_THEME["_default"];
