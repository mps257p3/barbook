...
const BASE_RECIPES = [
  ...
  {name:"Gin Tônica de Bergamota",categories:["Gim","Highball","Built"],ingredients:["50 ml Gin","150 ml Tônica","4 gomos de bergamota","2 gotas Angostura"],steps:["Esprema os gomos de bergamota no fundo da taça balão.","Encha com gelo. Adicione o gin.","Complete com tônica pela lateral. Pingue o Angostura."],notes:"Cítrico, levemente floral e com fundo amargo. Variação elegante do G&T clássico.",rating:3,servings:"",custom:false},
  ...
  {name:"Maraschino Spritz",categories:["Espumante","Luxardo Maraschino","Spritz","Built"],ingredients:["40 ml Luxardo Maraschino","80 ml espumante brut","40 ml água com gás","rodela de laranja ou limão"],steps:["Encha taça com gelo.","Adicione o Luxardo.","Complete com espumante e água com gás. Mexa. Decore com rodela de laranja."],notes:"Leve, levemente doce e com fundo elegante de amêndoa. Um aperitivo sofisticado.",rating:4,servings:"",custom:false},
  ...
  {name:"Negroni Sbagliato",categories:["Campari","Espumante","Spritz","Vermute Tinto","Built"],ingredients:["30 ml Campari","30 ml vermouth rosso","prosecco para completar"],steps:["Encha copo rocks com gelo.","Adicione Campari e vermouth rosso.","Complete com prosecco pela lateral. Mexa levemente.","Decore com casca de laranja."],notes:"Amargo, herbáceo e mais leve que o Negroni tradicional. As borbulhas suavizam o amargor.",rating:3,servings:"",custom:false},
