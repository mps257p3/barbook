...
const BASE_RECIPES = [
  ...
  {name:"Bourbon, laranja e gengibre",categories:["Bourbon","Triple Sec","Built"],ingredients:["60 ml bourbon","15 ml Triple Sec","15 ml xarope de gengibre","60 ml suco de laranja","gelo esmagado"],steps:["Combine tudo num copo alto com gelo esmagado.","Mexa suavemente e sirva."],notes:"",rating:0,servings:"1",custom:false},
  ...
  {name:"Old Fashioned",categories:["Bourbon","Stirred"],ingredients:["60 ml Bourbon","2 dashes Bitter","1 cubo açúcar","casca de laranja"],steps:["Macere açúcar e bitter no copo.","Adicione gelo e bourbon.","Mexa e decore com laranja."],notes:"",rating:0,servings:"",custom:false},
  ...
  {name:"Boulevardier",categories:["Campari","Bourbon","Vermute Rosso","Stirred"],ingredients:["45 ml bourbon","30 ml Campari","30 ml vermute tinto doce"],steps:["Mexa tudo com gelo por 30s.","Coe em taça ou rocks. Decore com laranja."],notes:"O Negroni com bourbon. Mais encorpado e quente.",rating:0,servings:"",custom:false},
  ...
  {name:"Gold Rush",categories:["Bourbon","Sour","Shaken"],ingredients:["60 ml bourbon","22 ml suco de limão","22 ml xarope de mel"],steps:["Combine tudo com gelo e agite.","Coe em rocks com gelo grande."],notes:"Primo do Bee's Knees. O mel suaviza o bourbon perfeitamente.",rating:0,servings:"1",custom:false},
  ...
  {name:"Paper Plane",categories:["Bourbon","Aperol","Sour","Shaken"],ingredients:["22 ml bourbon","22 ml Aperol","22 ml Amaro Nonino","22 ml suco de limão"],steps:["Combine em partes iguais com gelo.","Agite e coe em taça coupe."],notes:"Partes iguais. Moderno clássico de Sam Ross (2008).",rating:0,servings:"1",custom:false},
  ...
  {name:"Godfather",categories:["Whisky","Amaretto","Stirred"],ingredients:["45 ml Scotch whisky","25 ml Amaretto"],steps:["Coloque gelo em rocks.","Adicione e mexa suavemente."],notes:"Com vodka vira Godmother.",rating:0,servings:"",custom:false},
  ...
  {name:"Caipirinha de Limão-Cravo",categories:["Cachaça","Smash","Built"],ingredients:["1 limão-cravo pequeno","1/2 limão tahiti","10 ml xarope demerara","60 ml cachaça branca","gelo"],steps:["Macere os limões com o xarope.","Adicione gelo e cachaça.","Mexa bem."],notes:"O tahiti segura o frescor ácido; o cravo traz perfume e profundidade. Variação: troque o xarope por mel diluído para versão mais floral; adicione 1 rodela fina de gengibre para versão especiada e quente. Upgrade: 1 folha pequena de tangerina batida na mão.",rating:0,servings:"1",custom:false},
  ...
  {name:"Horse's Neck",categories:["Bourbon","Highball","Built"],ingredients:["60 ml bourbon","150 ml ginger ale","2 dash Angostura","casca de limão longa"],steps:["Enrole a casca de limão dentro do copo.","Adicione gelo e bourbon.","Complete com ginger ale e bitters."],notes:"",rating:0,servings:"",custom:false},
  ...
  // ── ST-GERMAIN ──
  {name:"Elder Fashion",categories:["Bourbon","St‑Germain","Stirred"],ingredients:["50 ml bourbon","20 ml St-Germain","1 dash Angostura","casca de limão"],steps:["Mexa tudo com gelo.","Coe em rocks com gelo.","Expresse a casca de limão."],notes:"Old Fashioned floral.",rating:0,servings:"",custom:false},
  ...
  {name:"Benevento Old Fashioned",categories:["Bourbon","Licor Strega","Stirred"],ingredients:["40 ml bourbon","15 ml Strega","1 dash Angostura","twist de laranja"],steps:["Combine tudo no copo baixo com gelo.","Mexa bem.","Expresse o twist de laranja."],notes:"O Strega entra como açúcar e tempero ao mesmo tempo.",rating:0,servings:"",custom:false},
...
function ProfileTab({ allRecipes, drinkCount, tried, favs, owned, customRecipes, exportJSON, importRef, user, syncing, onGoTo, onOpenRecipe, onRestoreAll, onRestoreRecipes, onAddRecipe, onTutorial }) {
  ...
  const SectionHead=({label})=>(
    <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:14}}>
      ...
      <span style={{...CARD_TYPO.sectionHead,color:"rgba(160,120,90,0.75)"}}>{label}</span>
    </div>
  );
  return (
    <div style={{paddingBottom:100}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
          {[
            ...
            <button key={l} onClick={()=>onGoTo(filter)}
              style={{background:"rgba(0,0,0,0.3)",border:"1px solid rgba(240,235,225,0.07)",borderRadius:12,padding:"18px 16px",textAlign:"left",cursor:"pointer",fontFamily:"Archivo,sans-serif",backdropFilter:"blur(8px)",transition:"border-color .15s"}}
        ...
        <div style={{background:"rgba(0,0,0,0.3)",border:"1px solid rgba(240,235,225,0.07)",borderRadius:12,overflow:"hidden",backdropFilter:"blur(8px)"}}>
          {[
            ...
            <button key={label} onClick={fn}
              style={{display:"flex",alignItems:"center",gap:10,padding:"14px 16px",width:"100%",background:"none",border:"none",borderBottom:i<arr.length-1?"1px solid rgba(240,235,225,0.05)":"none",color:accent?"#A0785A":"rgba(240,235,225,0.55)",fontSize:13,textAlign:"left",cursor:"pointer",fontFamily:"Archivo,sans-serif",boxSizing:"border-box"}}>
              {label}
            </button>
          ))}
      ...
      <div style={{marginBottom:16}}>
        ...
        <div style={{background:"rgba(0,0,0,0.3)",border:"1px solid rgba(240,235,225,0.07)",borderRadius:12,padding:"18px 18px",backdropFilter:"blur(8px)",display:"flex",flexDirection:"column",gap:12}}>
        ...
        <main ref={mainRef} className="app-main" style={{padding:"18px 22px 24px"}}>
          ...
          {mobileTab==="descobrir"&&!swipeRecipe ? (
            ...
            <div style={{paddingBottom:100,display:"flex",flexDirection:"column",gap:0}}>
              ...
              {/* adicionar bebida */}
              <div style={{marginBottom:24,background:"rgba(0,0,0,0.28)",border:"1px solid rgba(240,235,225,0.06)",borderRadius:14,padding:"18px 16px"}}>
                <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:14}}>
                  <div style={{height:1,width:14,background:"#A0785A",opacity:0.6,borderRadius:1}}/>
                ...
                <div style={{display:"flex",gap:8}}>
                  <input value={spiritSearch} onChange={e=>setSpiritSearch(e.target.value)}
                    ...
                    style={{flex:1,background:"rgba(240,235,225,0.04)",border:"1px solid rgba(240,235,225,0.08)",borderRadius:8,padding:"10px 14px",color:"#F0EBE1",fontSize:13,outline:"none",fontFamily:"Archivo,sans-serif"}}/>
                ...
                return(
                  <div>
                    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:14}}>
                      <div style={{display:"flex",alignItems:"center",gap:10}}>
                        <div style={{height:1,width:14,background:"#A0785A",opacity:0.6,borderRadius:1}}/>
                        <span style={{...CARD_TYPO.sectionHead,color:"rgba(160,120,90,0.75)"}}>Você pode fazer <span style={{color:"#C8A96E",fontFamily:"'Gloock',serif",fontSize:14,letterSpacing:0,textTransform:"none",fontWeight:400}}>{possiveis.length}</span></span>
                      </div>
                    ...
                    <div style={{display:"flex",flexDirection:"column",gap:8}}>
                      {possiveis.map(r=><DrinkCard key={r.id??r.name} recipe={r} isFav={favs.includes(r.name)} onFav={()=>toggleFav(r.name)} isTried={tried.includes(r.name)} onTried={()=>handleTried(r.name)} isComanda={comanda.includes(r.name)} onComanda={()=>toggleComanda(r.name)} hasAll={hasAllIngredients(r)} onClick={()=>setOpen(r)} onDelete={null} spiritCats={spiritCatsAll} customBg={customBgs[r.name]}/>)}
                    </div>
                  </div>
                );
              })()}
            ...
            <>
              ...
              <div className="mnv" style={{marginBottom:14,position:"relative"}}>
                <input ref={searchInputRef} value={search} onChange={e=>setSearch(e.target.value)} placeholder="buscar drink, ingrediente…" style={{width:"100%",background:"rgba(240,235,225,0.04)",border:"1px solid rgba(240,235,225,0.08)",borderRadius:3,padding:"9px 36px 9px 12px",color:"#F0EBE1",fontSize:13,boxSizing:"border-box"}} onFocus={e=>e.target.style.borderColor="rgba(160,120,90,0.35)"} onBlur={e=>e.target.style.borderColor="rgba(240,235,225,0.08)"}/>
